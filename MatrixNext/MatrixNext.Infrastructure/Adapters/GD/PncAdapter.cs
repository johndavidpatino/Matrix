...
namespace MatrixNext.Infrastructure.Adapters.GD
{
    ...
    public interface IPncAdapter
    {
        ...
        /// <summary>
        /// Obtiene un PNC específico por ID
        /// SP: PNC_GetById
        /// </summary>
        ...
        /// <summary>
        /// Crea causa para PNC (acción correctiva)
        ...
        /// <summary>
        /// Calcula resumen/estadísticas de PNC
        /// Operación: Aggregation en base de datos
        /// </summary>
