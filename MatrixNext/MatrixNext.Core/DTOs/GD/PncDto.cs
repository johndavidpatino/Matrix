...
namespace MatrixNext.Core.DTOs.GD
{
    ...
    public class PncDto
    {
        ...
        [Display(Name = "Tipo Asociación")]
        public string AsociadoATexto { get; set; } // Descripción: "Trabajo", "Actividad"
        ...
        public bool PuedeEditar => IdEstado == 1; // Solo si está en estado Registrado
        public bool PuedeRegistrarCausa => IdEstado == 1; // Solo si está en estado Registrado
    }
    ...
    public class PncCausaDto
    {
        ...
        [Required(ErrorMessage = "La descripción de causa es obligatoria")]
        [StringLength(1000, ErrorMessage = "La descripción no puede exceder 1000 caracteres")]
        [Display(Name = "Descripción Causa")]
        public string DescripcionCausa { get; set; }

        [Required(ErrorMessage = "La acción correctiva es obligatoria")]
        [StringLength(2000, ErrorMessage = "La acción no puede exceder 2000 caracteres")]
        ...
        public bool PuedeEditar => IdEstado == 1; // Solo si está abierta
    }
    ...
    /// <summary>
    /// DTO para Resumen/Estadísticas de PNC
    /// Ref: Cálculos locales (no SP específico)
    /// </summary>
    public class PncResumenDto
    {
        ...
        [Display(Name = "Causas Próximas a Vencer")]
        public int CausasProximasVencer { get; set; } // Próximos 3 días
    ...
    public class PncLogDto
    {
        ...
        public string Accion => $"{NombreEstadoAnterior} → {NombreEstadoNuevo}";
    }
}
