...
namespace MatrixNext.Data.DTOs.GD
{
    ...
    public class MaestroDocumentoDto
    {
        ...
        public long IdTipoSolicitud { get; set; } // 1=ConstrucciÃ³n, 2=ActualizaciÃ³n, 3=AnulaciÃ³n
    ...
    /// <summary>
    /// DTO para Tipo 1 (ConstrucciÃ³n): Crear maestro + documento controlado
    /// </summary>
    public class MaestroTipo1ConstruccionDto : MaestroDocumentoDto
    {
        public int TiempoRetencionAnios { get; set; } = 5; // Default
    ...
    /// <summary>
    /// DTO para Tipo 2 (ActualizaciÃ³n): Crear nueva versiÃ³n o actualizar existente
    /// </summary>
    ...
    /// <summary>
    /// DTO para Tipo 3 (AnulaciÃ³n): Marcar maestro como inactivo y documentos no controlados
    /// </summary>
