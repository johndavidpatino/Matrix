...
| Presupuesto interno | SolicitudPresupuestoInterno.aspx, SolicitudPresupuestosInternos.aspx | PresupInt (CoreProject), EnviarCorreo | En progreso | `/OP/Presupuestos` ya guarda los modos completo/simplificado y demanda notificaciones; el siguiente paso es enlazar la vista con el checklist telefónico. |
...
- Sprint 5 (Presupuestos internos + utilidades) en progreso: `/OP/Presupuestos` ya maneja los modos completo/simplificado y registra observaciones, mientras `/OP/Produccion` captura registros de actividades y prepara la integración iField/supervisión telefónica.
