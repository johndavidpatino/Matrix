...
#Region "Funciones y Métodos"
    ...
    Sub CargarEntrevistas()
        ...
        gvDistribucion.DataSource = o.ObtenerEntrevistasxTrabajo(hfidtrabajo.Value)
    ...
    End Sub
    Public Sub GuardarFichaEntrevista()
        Try
            Dim oTrabajo As New Trabajo
    ...
    Sub EnviarEmail(ByVal Nuevo As Boolean)
        ...
        End If
        oEnviarCorreo.enviarCorreo(WebMatrix.Util.obtenerUrlRaiz() & "/Emails/EntregaTrabajoEntrevistas.aspx?idFicha=" & Request.QueryString("idtrabajo").ToString & "&nuevo=" & Nuevo)
        ActivateAccordion(0, EffectActivateAccordion.NoEffect)
    End Sub
    ...
    Protected Sub btnEntrega_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnEntrega.Click
        If String.IsNullOrEmpty(hfidtrabajo.Value) Then
            Throw New Exception("Debe elegir un estudio o guardarlo antes de enviar una entrega")
        End If
        Dim script As String = "window.open('../Emails/EntregaTrabajoEntrevistas.aspx?idFicha=" & Request.QueryString("idtrabajo").ToString & "','cal','width=400,height=250,left=270,top=180')"
