<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/OPC_F.master"
    CodeBehind="FichaObservacion.aspx.vb" Inherits="WebMatrix.FichaObservacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>Acta de entrega de Proyecto - InHome </a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion1">
                    <h3>
                        <a href="#">
                            <label>
                                Información InHome<asp:HiddenField ID="hfidfichaobservacion" 
                            runat="server" /><asp:HiddenField ID="hfidtrabajo" runat="server" />
                        </label>
                        &nbsp;</a></h3>
                    <div class="block">
                            ...
                            <div>
                                ...
                                <div class="form_left">
                                    ...
                                    <div class="actions">
                                        ...
                                        <asp:GridView ID="gvInHome" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                                        CssClass="displayTable" AlternatingRowStyle-CssClass="odd" PagerStyle-CssClass="headerfooter ui-toolbar"
                                        DataKeyNames="Id,CiudadId,IdModerador,IdEstado" AllowPaging="True" EmptyDataText="No existen InHome para mostrar">
