    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            If txtBackups.Text = "" Then
                ShowNotification("Escriba los Backups Necesarios para el InHome", ShowNotifications.ErrorNotification)
                txtBackups.Focus()
                ActivateAccordion(1, EffectActivateAccordion.NoEffect)
                Exit Sub
            End If

            GuardarFichaObservacion()
...
#Region "Funciones y Métodos"
    ...
    End Sub
    Public Sub GuardarFichaObservacion()
        Try
            Dim oTrabajo As New Trabajo
    ...
    Sub EnviarEmail(ByVal Nuevo As Boolean)
        ...
        End If
        oEnviarCorreo.enviarCorreo(WebMatrix.Util.obtenerUrlRaiz() & "/Emails/EntregaTrabajoObservaciones.aspx?idFicha=" & Request.QueryString("idtrabajo").ToString & "&nuevo=" & Nuevo)
        ActivateAccordion(0, EffectActivateAccordion.NoEffect)
    End Sub
    Protected Sub btnEntrega_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnEntrega.Click
        Try
            If String.IsNullOrEmpty(hfidfichaobservacion.Value) Then
                Throw New Exception("Debe elegir un estudio o guardarlo antes de enviar una entrega")
            End If
            Dim script As String = "window.open('../Emails/EntregaTrabajoObservaciones.aspx?idFicha=" & Request.QueryString("idtrabajo").ToString & "','cal','width=400,height=250,left=270,top=180')"
