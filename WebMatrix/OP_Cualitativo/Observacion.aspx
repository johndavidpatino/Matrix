<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/OPC_F.master"
    CodeBehind="Observacion.aspx.vb" Inherits="WebMatrix.Observacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_Head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function redireccion() {
            var idobservacion = $('#<%= hfFichaObservacionID.ClientID %>').val();
            document.location.href = 'Observacion.aspx?idobservacion=' + idobservacion;
            ...
            <div id="accordion">
                <div id="accordion1">
                    <h3>
                        <a href="#">
                            <label>
                                Lista de Detalles de Observaciones</label>
                        </a>
                    </h3>
                    <div class="block">
                        <div class="form_left">
                            <fieldset>
                                <label>
                                    Ciudad, Persona, Dirección o Teléfono<asp:HiddenField ID="hfFichaObservacionID" runat="server" />
                                </label>
                        ...
                        <asp:GridView ID="gvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="FichaObservacionId" HeaderText="ID Ficha Observacion" />
                ...
                <div id="accordion2">
                    <h3>
                        <a href="#">
                            <label>
                                Información de la Observación</label>
                        </a>
                    </h3>
                    <div class="block">
                                ...
                                <asp:Panel ID="Panel1" runat="server" >
                                    <div class="form_left">
                                        <fieldset>
                                            ...
                                            <asp:HiddenField ID="hfObservacionID" runat="server" />
