<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/PY_F.master"
    CodeBehind="AprobacionesFiltros.aspx.vb" Inherits="WebMatrix.AprobacionesFiltros" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_ContentForm" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upDatos">
        <ContentTemplate>
            ...
            <p style="color: White;">Respuestas Filtros Reclutamiento</p>
            <div class="actions">
                <div class="actions">
                ...
                <label style="color: white; font-size: 18px">Información Filtros Reclutamiento</label>
                <br />
                <br />
                <div>
                ...
                <br />
                <asp:GridView ID="gvRespuestas" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Aprobación OPS" ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgAprobacionOPS" runat="server" CausesValidation="False" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                    CommandName="GestionOPS" ImageUrl="~/Images/select_16.png" Text="Aprobación OPS" ToolTip="Aprobación OPS" OnClientClick="MostrarAprobacionFiltros()" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Aprobación GP" ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgAprobacionGP" runat="server" CausesValidation="False" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                    CommandName="GestionGP" ImageUrl="~/Images/select_16.png" Text="Aprobación GP" ToolTip="Aprobación GP" OnClientClick="MostrarAprobacionFiltros()" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    </Columns>
