<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/OPC_F.master"
    CodeBehind="FichaSesion.aspx.vb" Inherits="WebMatrix.FichaSesion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>Acta de entrega de Proyecto - Sesiones de Grupos </a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion2">
                    <h3>
                        <a href="#">
                            <label>
                                Información Sesiones<asp:HiddenField ID="hfidfichasesion" runat="server" /><asp:HiddenField ID="hfidtrabajo" runat="server" />
                            </label>
                        </a>
                    </h3>
                    <div class="block">
                            ...
                            <div>
                                <asp:Panel ID="Panel1" runat="server">
                                    ...
                                    <div class="actions">
                                        ...
                                        <asp:GridView ID="gvSesiones" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
