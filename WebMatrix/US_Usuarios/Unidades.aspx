<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SG_F.master" CodeBehind="Unidades.aspx.vb" Inherits="WebMatrix.Unidades" %>
...
<h3><a href="#"><label>Lista de unidades</label></a></h3><br />
            <div class="form_left">
                <fieldset>                    
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,Unidad,GrupoUnidadId,GrupoUnidad" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Unidad" HeaderText="Nombre" ReadOnly="True" SortExpression="Unidad" />
        <asp:BoundField DataField="GrupoUnidad" HeaderText="Grupo Unidad" ReadOnly="True" SortExpression="GrupoUnidad" />
