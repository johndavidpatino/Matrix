<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SG_F.master" CodeBehind="Roles.aspx.vb" Inherits="WebMatrix.Roles" %>
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,Rol" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Rol" HeaderText="Nombre" ReadOnly="True" SortExpression="Rol" />
                    ...
                    <asp:TemplateField HeaderText="Usuarios" ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgRU" runat="server" CausesValidation="False" 
                                CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" 
                                CommandName="RolesUsuarios" ImageUrl="~/Images/seg.png" 
                                Text="Usuarios" ToolTip="Usuarios" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
    </Columns>
        ...
        <div class="form_right">
            <fieldset>
                ...
                <input Id="btnCancelar" type="button" class="button" value="Cancelar"  runat="server"
                                        style="font-size: 11px;" onclick="location.href='Roles.aspx';" />
            </fieldset>
        </div>
</div>
<div class="actions">
