<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SG_F.master" CodeBehind="GruposPermisos.aspx.vb" Inherits="WebMatrix.GruposPermisos" %>
...
<h3><a href="#"><label>Lista de grupos permiso</label></a></h3><br />
            <div class="form_left">
                <fieldset>                    
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,GrupoPermisos" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="GrupoPermisos" HeaderText="Nombre" ReadOnly="True" SortExpression="GrupoPermisos" />
                    ...
                    <asp:TemplateField HeaderText="Permisos" ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgP" runat="server" CausesValidation="False" 
                                CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" 
                                CommandName="Permisos" ImageUrl="~/Images/seg.png"
                                Text="Permisos" ToolTip="Permisos" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
    </Columns>
