<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SG_F.master" CodeBehind="Permisos.aspx.vb" Inherits="WebMatrix.Permisos" %>
...
<h3><a href="#"><label>Lista de Permisos</label></a></h3><br />
            <div class="form_left">
                <fieldset>                    
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,Permiso,GrupoId,GrupoPermisos" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Permiso" HeaderText="Nombre" ReadOnly="True" SortExpression="Permiso" />
        <asp:BoundField DataField="GrupoPermisos" HeaderText="Grupo Permiso" ReadOnly="True" SortExpression="GrupoPermisos" />
                    ...
                    <asp:TemplateField HeaderText="Roles" ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgRP" runat="server" CausesValidation="False" 
                                CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" 
                                CommandName="RolesPermisos" ImageUrl="~/Images/seg.png" 
                                Text="Roles" ToolTip="Roles" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
    </Columns>
        ...
        <div class="form_right">
            <fieldset>
                ...
                <input id="btnCancelar" type="button" class="button" value="Cancelar"  runat="server"
                                        style="font-size: 11px;" onclick="location.href='GruposPermisos.aspx';" />
            </fieldset>
        </div>
</div>
<div class="actions">
