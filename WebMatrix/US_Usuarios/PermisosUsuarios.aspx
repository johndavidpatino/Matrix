<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SG_F.master" CodeBehind="PermisosUsuarios.aspx.vb" Inherits="WebMatrix.PermisosUsuarios" %>
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="PermisoId,UsuarioId,Permiso" 
...
<div Id="datos" runat="server" visible="false">
    ...
    <div class="actions">
        ...
        <div class="form_left">
        <label>Grupo Permiso:</label>
            <asp:DropDownList ID="ddlGrupoPermiso" runat="server" AutoPostBack="True">
            </asp:DropDownList>
        </div>
