<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/TH_F.master" CodeBehind="ListadoHojasDeVida.aspx.vb" Inherits="WebMatrix.ListadoHojasDeVida" %>
            ...
            <div class="block">
                ...
                <asp:GridView ID="gvContratacion" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DivMuniNombre" HeaderText="DivMuniNombre" />
                        <asp:BoundField DataField="TipoContratacionTexto" HeaderText="TipoContratacion" />
                        <asp:TemplateField HeaderText="Ver HV" ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgIrActualizar" runat="server" CausesValidation="False" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                    ...
                                    ToolTip="Ir a la hoja de vida de esta persona" />
                            </ItemTemplate>
