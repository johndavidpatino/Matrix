<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterGeneral2.master" CodeBehind="HWH-RH.aspx.vb" Inherits="WebMatrix.HWH_RH" %>
                ...
                <div class="row">
                    <div style="width: 24%; float: left;">
                        <div class="form-group" style="width: auto; margin: auto 20px;">
                            <label for="ddlJefe" style="width: auto; margin: auto 20px;">Jefe</label>
                            <asp:DropDownList runat="server" ID="ddlJefe" CssClass="form-control izq">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div style="width: 24%; float: left;">
                    ...
                    <div style="width: 90%;">
                        ...
                        <asp:Button Text="Descargar" ID="btnDescargar" Visible="false" runat="server" CssClass="btn btn-default" />
                    </div>
                </div>
                <div class="row"></div>
                <asp:Panel runat="server" ID="pnlTeleTrabajo" Visible="true">
                    <asp:GridView ID="gvTeleTrabajo" runat="server" Width="90%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Usuario_Gestion" HeaderText="Manager Aprueba" />
