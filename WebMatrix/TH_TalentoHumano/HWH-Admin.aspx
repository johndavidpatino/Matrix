<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterGeneral2.master" CodeBehind="HWH-Admin.aspx.vb" Inherits="WebMatrix.HWH_Admin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var fechaMax = null;
            if (hoy.getMonth() == 11) {
                fechaMin = new Date(hoy.getFullYear() + 0, 0, 1);
            } else {
                fechaMin = new Date(hoy.getFullYear(), hoy.getMonth() + 0, 1);
            }
            ...
            //console.log(convert(hoy.toString()));
            //console.log(convert(fechaMin.toString()));
            //console.log(convert(fechaMax.toString()));
            ...
            $("#CPH_Content_txtFechaIni").val(convert(fechaMin));
            $("#CPH_Content_txtFechaFin").val(convert(fechaMax));

        });

        function activarBusquedaHWH() {
            $('#accordion').accordion({
                active: 1
            });
        }

        function limpiarBusquedaHWH() {
            $('#accordion').accordion({
                active: 0
            });
        }
    ...
    <div class="col-md-12">
        <div id="accordion">
            <div id="accordion0">
                ...
                <div class="block">
                    <asp:UpdatePanel ID="pnlListado" runat="server">
                        <ContentTemplate>
                            <div class="row">
                                <%--<div style="width: 24%; float: left;">
                                    <div class="form-group" style="width: auto; margin: auto 20px;">
                                        <label for="txtUsuarioBuscar" style="width: auto; margin: auto 20px; ">Área</label>
                                        <asp:DropDownList runat="server" ID="ddlArea" CssClass="form-control izq" Visible="false">
                                        </asp:DropDownList>
                                    </div>
                                </div>--%>
                                <div style="width: 24%; float: left;">
                                    <div class="form-group" style="width: auto; margin: auto 20px;">
                                        <label for="txtFechaIni" style="width: auto; margin: auto 20px;">Fecha Inicio</label>
                                        <asp:TextBox runat="server" CssClass="form-control izq FechaSelect" ID="txtFechaIni" />
                                    </div>
                                </div>
                                <div style="width: 24%; float: left;">
                                    <div class="form-group" style="width: auto; margin: auto 20px;">
                                        <label for="txtFechaFin" style="width: auto; margin: auto 20px;">Fecha Fin</label>
                                        <asp:TextBox runat="server" CssClass="form-control izq FechaSelect" ID="txtFechaFin" />
                                    </div>
                                </div>
                                <div style="width: 24%; float: left;">
                                    <div class="form-group" style="width: auto; margin: auto 20px;">
                                        <label style="width: auto; margin: auto 20px; "></label>                                        
                                    </div>
                                </div>
                                <div style="width: 24%; float: left;">
                                    <div class="form-group" style="width: auto; margin: auto 20px;">
                                        <label for="txtUsuarioBuscar" style="width: auto; margin: auto 20px;">Estado</label>
                                        <asp:DropDownList runat="server" ID="ddlEstados" CssClass="form-control izq">
                                            <asp:ListItem Value="-1" Text="--Todos--" />
                                            <asp:ListItem Value="1" Selected="True" Text="Pendiente de Aprobación" />
                                            <asp:ListItem Value="2" Text="Aprobado" />
                                            <asp:ListItem Value="3" Text="Rechazado" />
                                            <asp:ListItem Value="4" Text="Anulado" />
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div style="width: 90%;">
                            ...
                            <div class="row"></div>
                            <asp:Panel runat="server" ID="pnlTeleTrabajo" Visible="true">
                                <asp:GridView ID="gvTeleTrabajo" runat="server" Width="90%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:BoundField DataField="UsuApru" HeaderText="Manager Aprueba" />--%>
                                        <asp:BoundField DataField="Fecha_Gestion" HeaderText="Fecha de Gestión" DataFormatString="{0:dd/MM/yyyy}" />
                                        ...
                                        <asp:TemplateField HeaderText="Gestionar" ShowHeader="False" ItemStyle-CssClass="text-center transparent">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgGestionar" runat="server" CausesValidation="False" CssClass="transparent" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                                    CommandName="Gestionar" ImageUrl="~/Images/Select_16.png" Text="Gestionar HWH" ToolTip="Gestionar HWH" OnClientClick="activarBusquedaHWH();" />
                                            </ItemTemplate>
            ...
            <div id="accordion1">
                <h3><a href="#">Gestionar  Easy Work</a></h3>
                <div class="block">
                        ...
                        <ContentTemplate>
                            <div class="row">
                                <div class="form-horizontal">
                                    ...
                                    <asp:Panel runat="server" ID="formDocumento" Enabled="false">
                                        <div class="form-group">
                                            <label for="txtUsuario">Documento</label>
                                            <asp:TextBox runat="server" class="form-control" ID="txtUsuario"></asp:TextBox>
                                            <label style="margin: 5px 0 0 15px; width: auto;" runat="server" id="lblUsuario"></label>
                                        </div>
                                    </asp:Panel>
                                    <asp:Panel runat="server" ID="formEstado" Enabled="false">
                                        <div class="form-group">
                                            <label for="txtEstado">Estado</label>
                                            <asp:TextBox runat="server" class="form-control" ID="txtEstado"></asp:TextBox>
                                        </div>
                                    </asp:Panel>
                                    <asp:Panel runat="server" ID="formFecha" Enabled="false">
                                        <div class="form-group">
                                            <label for="txtFecha">Fecha</label>
                                            <asp:TextBox runat="server" class="form-control" ID="txtFecha"></asp:TextBox>
                                        </div>
                                    </asp:Panel>
                                    <div class="form-group">
                                    ...
                                    <div style="float: right;">
                                        <button class="btn btn-primary" visible="false" style="margin: 0px 5px;" id="btnAprobar" runat="server" onclick="limpiarBusquedaHWH();"><i class="fa fa-check"></i>Aprobar</button>
                                        <button class="btn btn-primary" visible="false" style="margin: 0px 5px;" id="btnRechazar" runat="server" onclick="limpiarBusquedaHWH();"><i class="fa fa-close"></i>Rechazar</button>
                                        <button class="btn btn-primary" visible="false" style="margin: 0px 5px;" id="btnAnular" runat="server" onclick="limpiarBusquedaHWH();"><i class="fa fa-ban"></i>Anular</button>
                                        <button class="btn btn-primary" style="margin: 0px 5px;" id="btnLimpiar" runat="server" onclick="limpiarBusquedaHWH();">Limpiar</button>
                                    </div>
                                </div>
                            </div>
                        </ContentTemplate>
