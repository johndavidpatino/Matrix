<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/GD_F.master" CodeBehind="GD_Procesos.aspx.vb" Inherits="WebMatrix.GD_Procesos" %>
...
<h3><a href="#"><label>Lista de Procesos</label></a></h3><br />
            <div class="form_left">
                <fieldset>                    
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="IdProceso,Proceso" 
                ...
                <AlternatingRowStyle CssClass="odd" />
    <Columns>
        <asp:BoundField DataField="IdProceso" HeaderText="Id" ReadOnly="True" SortExpression="IdProceso" />
