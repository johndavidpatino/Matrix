<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/GD_F.master" CodeBehind="Aprobacion.aspx.vb" Inherits="WebMatrix.Aprobacion" %>
...
<h3><a href="#"><label>Lista de pendientes por aprobar</label></a></h3><br />
            <div class="form_left">
                <fieldset>                    
...
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="IdRevision,DocumentoId,UsuarioId,FechaAprobacion,TipoRevisionId,TipoRevision,DocumentoControladoId,NombreDocumento" 
                AlternatingRowStyle-CssClass="odd"  PageSize="25"
