<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/GD_F.master" CodeBehind="GD_EstadoSolicitud.aspx.vb" Inherits="WebMatrix.EstadoSolicitud" %>
...
<h3><a href="#"><label>Estados de Solicitud</label></a></h3><br />
            <div class="form_left">
                <fieldset>                    
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="id,Estado" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Estado" HeaderText="Estado Solicitud" ReadOnly="True" SortExpression="Estado" />
...
<div Id="datos" runat="server" visible="false">
    ...
    <div class="actions">
        ...
        <div class="form_left">
        <label runat="server" id="lblid">Id:</label>
        <asp:TextBox ID="txtId" runat="server" ></asp:TextBox>
        </div>

        <div class="form_left">
        <label>Nombre Estado de Solicitud:</label>
