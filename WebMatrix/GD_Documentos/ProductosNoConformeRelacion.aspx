<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/GD_F.master" CodeBehind="ProductoNoConformeRelacion.aspx.vb" Inherits="WebMatrix.ProductoNoConformeRelacion" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_ContentForm" runat="server">
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td width="10%"><asp:Button ID="btnTodos" runat="server" Text="VerTodos" Width="80px" BackColor="#CC3300" Font-Bold="True" ForeColor="White" /></td>
        </tr>
    </table>
    <table style="width:100%;"> 
        <tr>
