<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/GD_F.master" CodeBehind="GD_TipoSolicitud.aspx.vb" Inherits="WebMatrix.GD_TipoSolicitud" %>
...
<h3><a href="#"><label>Tipos de Solicitud</label></a></h3><br />
            <div class="form_left">
                <fieldset>                    
...
<br />
<asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="id,Tipo" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Tipo" HeaderText="Tipo Solicitud" ReadOnly="True" SortExpression="Tipo" />
