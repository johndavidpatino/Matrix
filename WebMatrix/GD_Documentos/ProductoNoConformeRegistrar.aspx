<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/GD_F.master" CodeBehind="ProductoNoConformeRegistrar.aspx.vb" Inherits="WebMatrix.ProductoNoConformeRegistrar" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_ContentForm" runat="server">
    ...
    <table style="width:100%;"> 
                ...
                <asp:GridView ID="GVPNC" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descripcion">
                            <ItemTemplate>
                                <asp:TextBox ID="Descripcion" runat="server" TextMode="MultiLine" Width="220px" Text='<%# Bind("Descripcion")%>' Height="30px"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>                  
                    </Columns>
                    <SelectedRowStyle foreColor="red" font-bold="true"/>
        ...
        <tr>  
            <td width="100%"><a>CAUSAS</a></td>
        </tr>
        <tr> 
            <td width="100%">
                <asp:GridView ID="GVPNCCausas" runat="server" AllowPaging="True" 
                    AutoGenerateColumns="False"  CssClass="displayTable" PageSize="5" Width="100%" EmptyDataText="No existen datos" AutoGenerateSelectButton="True">
                    <AlternatingRowStyle VerticalAlign="Top" />
                    <Columns>
                        <asp:BoundField DataField="IdPNC" HeaderText="IdPNC" />
                        <asp:BoundField DataField="IdCausa" HeaderText="IdCausa" />
                        <asp:TemplateField HeaderText="Descripcion">
                            <ItemTemplate>
                                <asp:TextBox ID="CausaRaiz" runat="server" TextMode="MultiLine" Width="900px" Text='<%# Bind("CausaRaiz")%>' Height="30px"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>                  
                    </Columns>
                    <SelectedRowStyle foreColor="red" font-bold="true"/>
        ...
        <tr> 
            <td width="100%">
                <asp:GridView ID="GVPNCAcciones" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Accion" HeaderText="TipoAccion" /> 
    ...
    <Table style="width:100%;">
        <tr>
            <td width="80%"><asp:Button ID="btnGrabarPNC" runat="server" Text="GRABAR NUEVO PNC" Width="150px" BackColor="#CC3300" Font-Bold="True" ForeColor="White" /></td>
        </tr>
    </Table>
    ...
    <Table style="width:100%;">
        <tr>
            ...
            <td width="80%"><asp:TextBox ID="txtCausa" runat="server" TextMode="MultiLine" Width="100%" MaxLength="200"></asp:TextBox></td>
            <td width="10%"><asp:Button ID="btnGrabarCausa" runat="server" Text="GRABAR CAUSA" Width="150px" BackColor="#CC3300" Font-Bold="True" ForeColor="White" /></td>
        </tr>
    </table>
    ...
    <table style="width:100%;">
        <tr>
            <td><asp:Button ID="btnGrabarAccion" runat="server" Text="AGREGAR ACCIONES" Width="150px"  BackColor="#CC3300" Font-Bold="True" ForeColor="White" /></td>
