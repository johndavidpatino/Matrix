<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="../MasterPage/MPNewMatrix.Master" CodeBehind="Home.aspx.vb" Inherits="WebMatrix.Home_HomeForm" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="CPH_SideBar" runat="server">
    ...
    <li>
        <a href="../CU_Cuentas/Default.aspx" class="nav-link nav-link-white"><i class="metismenu-icon fa fa-briefcase"></i>
            Cuentas
        </a>
    </li>
    <li>
        <a href="../PY_Proyectos/Default.aspx" class="nav-link nav-link-white">
    ...
    <li>
        <a href="../TH_TalentoHumano/Home.aspx" class="nav-link nav-link-white">
            <i class="metismenu-icon fa fa-user-friends"></i>
            Recursos Humanos
        </a>
    </li>
    <li>
        <a href="../IT/Default.aspx" class="nav-link nav-link-white">
            <i class="metismenu-icon fa fa-rss"></i>
            Tecnología
        </a>
    </li>
    <li class="app-sidebar__heading">Calidad</li>
    <li><a href="../SGC_Calidad/SGC_Calidad_Home.aspx" class="nav-link nav-link-white">
