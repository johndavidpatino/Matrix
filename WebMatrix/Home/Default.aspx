<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MPNewMatrix.Master" CodeBehind="Default.aspx.vb" Inherits="WebMatrix.Home_Default" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="CPH_SideBar" runat="server">
    ...
    <li>
        <a href="../SGC_Calidad/AuditoriasInternas/Auditor.aspx" class="nav-link nav-link-white">
