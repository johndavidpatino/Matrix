<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/PY_F.master"
    CodeBehind="ControlCalidadInforme.aspx.vb" Inherits="WebMatrix.ControlCalidadInforme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_Head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function redireccion() {
            ...
            document.location.href = 'ControlCalidadInforme.aspx?idtrabajo=' + idtrabajo;
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>CONTROL DE CALIDAD DE INFORME PARA PROYECTOS CUALITATIVOS</a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion1">
                    <h3>
                        <a href="#">
                            <label>
                                Lista de Control de Calidad de Informe</label>
                        </a>
                    </h3>
                    <div class="block">
                        <div class="form_left">
