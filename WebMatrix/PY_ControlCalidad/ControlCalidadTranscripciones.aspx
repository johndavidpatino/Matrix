<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/PY_F.master" CodeBehind="ControlCalidadTranscripciones.aspx.vb" Inherits="WebMatrix.ControlCalidadTranscripciones" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>CONTROL DE CALIDAD TRANSCRIPCIONES PARA PROYECTOS CUALITATIVOS</a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion1">
                    <h3>
                        <a href="#">
                            <label>
                                Lista de Control de Transcripciones</label>
                        </a>
                    </h3>
                    <div class="block">
                        <div class="form_left">
                ...
                <div id="accordion2">
                    <h3>
                        <a href="#">
                            <label>
                                Información de Transcripciones</label>
                        </a>
                    </h3>
                    <div class="block">
