...
Public Class EvaluacionEntrevistadora
...
#Region "Funciones y Metodos"
    ...
    Public Sub CargarEvaluacion()
        Try
            ...
            Dim listaEvaluacion = (From lEvaluacion In oEvaluacion.DevolverxIdTipoProcesoyTrabajo(TrabajoId, TipoProceso.EvaluacionEntrevistadora)
    ...
    Public Sub CargarGrid()
        Try
            ...
            Dim listapregunta = (From lpregunta In oPregunta.DevolverxIdTipo(TipoProceso.EvaluacionEntrevistadora)
    ...
    Public Sub GuardarEvaluacion()
        Try
            ...
            End If
            IdEvaluacion = oEvaluacion.Guardar(IdEvaluacion, TrabajoId, IdPersona, Evaluador, RoleEvaluador, Fecha, Comentarios, TipoProceso.EvaluacionEntrevistadora)
    ...
    Public Sub log(ByVal iddoc As Int64?, ByVal idaccion As Int16)
        Try
            ...
            log.Guardar(23, iddoc, Now(), Session("IDUsuario"), idaccion)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
