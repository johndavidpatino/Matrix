...
Public Class ControlCalidadTranscripciones
...
#Region "Funciones y Metodos"
    ...
    Public Sub CargarControlCalidad()
        Try
            ...
            Dim listaControl = (From lcontrol In oControlCalidad.DevolverxIdTipoProcesoyTrabajo(TrabajoId, TipoProceso.ControlCalidadTranscripcion)
    ...
    Public Sub CargarGrid()
        Try
            ...
            Dim listapregunta = (From lpregunta In oPregunta.DevolverxIdTipo(TipoProceso.ControlCalidadTranscripcion)
    ...
    Public Sub GuardarControlCalidad()
        Try
            ...
            End If
            IdControl = oControlCalidad.Guardar(IdControl, TrabajoId, Evaluador, RoleEvaluador, IdPersona, Fecha, TipoProceso.ControlCalidadTranscripcion)
    ...
    Public Sub log(ByVal iddoc As Int64?, ByVal idaccion As Int16)
        Try
            ...
            log.Guardar(22, iddoc, Now(), Session("IDUsuario"), idaccion)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
