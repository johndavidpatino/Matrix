...
Public Class ControlCalidadCampo
...
#Region "Funciones y Metodos"
    ...
    Public Sub CargarControlCalidad()
        Try
            ...
            Dim listaControl = (From lcontrol In oControlCalidad.DevolverxIdTipoProcesoyTrabajo(TrabajoId, TipoProceso.ControlCalidadCampo)
    ...
    Public Sub CargarGrid()
        Try
            ...
            Dim listapregunta = (From lpregunta In oPregunta.DevolverxIdTipo(TipoProceso.ControlCalidadCampo)
    ...
    Public Sub GuardarControlCalidad()
        Try
            ...
            End If
            IdControl = oControlCalidad.Guardar(IdControl, TrabajoId, Evaluador, RoleEvaluador, IdPersona, Fecha, TipoProceso.ControlCalidadCampo)
    ...
    Public Sub log(ByVal iddoc As Int64?, ByVal idaccion As Int16)
        ...
        log.Guardar(20, iddoc, Now(), Session("IDUsuario"), idaccion)
