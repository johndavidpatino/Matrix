<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/PY_F.master"
    CodeBehind="Preguntas.aspx.vb" Inherits="WebMatrix.Preguntas" %>
            ...
            <div id="accordion">
                ...
                <div id="accordion2">
                    <h3>
                        <a href="#">
                            <label>
                                Información de la Pregunta</label>
                        </a>
                    </h3>
                    <div class="block">
                            ...
                            <div>
                                <div class="form_left">
                                    <fieldset>
                                     <label>
                                        ...
                                        <asp:DropDownList ID="ddlTipo" runat="server" CssClass="dropdowntext">
                                        </asp:DropDownList>
                                    </fieldset>
                                </div>
                                <div class="form_left">
                                ...
                                <div class="form_left">
                                    <fieldset>
                                        <label>
                                            Pregunta</label>
                                        <asp:TextBox ID="txtPregunta" runat="server" CssClass="textMultiline" Height="100px"
                                    ...
                                    <div class="form_right">
                                        <fieldset>
                                            ...
                                            <input id="Button1" type="button" class="button" value="Cancelar"  
                                                style="font-size: 11px;" onclick="location.href='Preguntas.aspx';" />
                                        </fieldset>
                                    </div>
                                </div>
                            </div>
