<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/PY_F.master" CodeBehind="EvaluacionEntrevistadora.aspx.vb" Inherits="WebMatrix.EvaluacionEntrevistadora" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_Head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function redireccion() {
            ...
            document.location.href = 'EvaluacionEntrevistadora.aspx?idtrabajo=' + idtrabajo;
            ...
            <div id="accordion">
                <div id="accordion1">
                    ...
                    <div class="block">
                        <div class="form_left">
                            <fieldset>
                                <label>
                                    Evaluador o Entrevistadora</label>
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="RoleEvaluador" HeaderText="RoleEvaluador" />
                                  <asp:BoundField DataField="Fecha" HeaderText="Fecha" DataFormatString="{0:dd/MM/yyyy}"
                                    HtmlEncode="False" />
                                <asp:BoundField DataField="Moderadora" HeaderText="Moderadora" />
                ...
                <div id="accordion2">
                    <h3>
                        <a href="#">
                            <label>
                                Información de Evaluación</label>
                        </a>
                    </h3>
                    <div class="block">
                        <fieldset class="validationGroup">
                            <div>
                                ...
                                <label>
                                    ...
                                    <p style="font-size: 10px"  >Por favor, califique en una escala de 1 a 5 (donde 1 es totalmente insatisfecho y 5 totalmente satisfecho), los siguientes aspectos del desempeño de la moderadora:</p>
                                <asp:Panel ID="pnllistaorden" runat="server" Height="200px" ScrollBars="Auto">
                                    <asp:GridView ID="gvPreguntas" runat="server" AutoGenerateColumns="False" CssClass="displayTable"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Calificación" ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:RadioButtonList ID="rblcalificacion" runat="server" RepeatDirection="Horizontal">
                                ...
                                <div class="form_left">
                                    <fieldset>
                                        <label>
                                            Observación o Comentarios</label>
                                        <asp:TextBox ID="txtObservacion" runat="server" CssClass="textMultiline" Height="100px"
