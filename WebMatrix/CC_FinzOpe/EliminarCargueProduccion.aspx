<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/CAP_F.master" CodeBehind="EliminarCargueProduccion.aspx.vb" Inherits="WebMatrix.EliminarCargueProduccion" %>
        ...
        <ContentTemplate>
            ...
            <div class="form_left">
                 <div id="accordion">
                    <div id="accordion0">
                        <h3><a href="#">
                            <label>Cargues Produccion</label></a></h3>
                        <div class="block">
                        <div class="form_left">
                            <fieldset>
                        ...
                        <div class="form_left">
                            <fieldset>
                                <label>Usuario</label>
                                <asp:DropDownList ID="ddlUsuario" runat="server" AutoPostBack="true" CssClass="mySpecificClass"></asp:DropDownList>
                                    ...
                                    <asp:GridView ID="GvCargues" runat="server" Width="100%" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                            ...
                                            <asp:BoundField DataField="DesdeId" HeaderText="DesdeId" />
