<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/FI_F.master" CodeBehind="ConteoTrabajos.aspx.vb" Inherits="WebMatrix.ConteoTrabajos" %>
					...
					<div class="block">
						...
						<asp:GridView ID="gvTrabajos" runat="server" Width="100%" AutoGenerateColumns="false"
							...
							<Columns>
								...
								<asp:BoundField DataField="ObservacionCOE" HeaderText="ObservacionOMP" Visible="false">
									<ItemStyle HorizontalAlign="Justify" Wrap="True" Width="100px" Height="100px" />
								</asp:BoundField>
								<asp:TemplateField HeaderText="Conteo" ShowHeader="False">
									<ItemTemplate>
										<asp:ImageButton ID="imgConteo" runat="server" CausesValidation="False" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
											CommandName="Conteo" ImageUrl="~/Images/list_16_.png" Text="Actualizar" ToolTip="Realizar Conteo" />
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Center" />
								</asp:TemplateField>
								<asp:TemplateField HeaderText="ProcesosInternos" ShowHeader="False">
									<ItemTemplate>
										<asp:ImageButton ID="imgProcesos" runat="server" CausesValidation="False" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
											CommandName="Procesos" ImageUrl="~/Images/page_attach.png" Text="Procesos"
											ToolTip="Procesos Internos" />
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Center" />
								</asp:TemplateField>
							</Columns>
						...
						<asp:Panel ID="pnlPreguntas" runat="server" Visible="false">
							<table style="width: 100%;">
								<tr>
									...
									<td>Cerradas multiples
									</td>
									<td>Abiertas
									</td>
									<td>Abiertas multiples
									</td>
									<td>Otros
									</td>
									<td>Demograficos
								...
								<tr>
									...
									<td>
										<asp:TextBox ID="DuracionProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="CerradasProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="CerradasMultProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="AbiertasProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="AbiertasMultProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="OtrosProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="DemoProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="PagProp" runat="server" Width="60px" ReadOnly="True"></asp:TextBox>
									</td>
								</tr>
							</table>
							<br />
							...
							<table style="width: 100%;">
								...
								<tr>
									<td></td>
									<td>
										<asp:TextBox ID="DuracionReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="CerradasReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="CerradasMultReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="AbiertasReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="AbiertasMultReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="OtrosReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="DemoReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="PagReal" runat="server" Width="60px"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="ObsReal" runat="server" Width="60px"></asp:TextBox>
									</td>
								</tr>
								<tr>
							...
							<asp:Button ID="btnGuardarPreguntas" runat="server" Text="Guardar conteo" CssClass="button btnBorder" />
							<br />
							<br />
							<div class="clear"></div>
							<h4>Diferencias Conteo</h4>
							<table style="width: 100%;">
								<tr>
									<td>&nbsp;
									</td>
								...
								<tr>
									<td></td>
									<td>
										<asp:TextBox ID="DuracionD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="CerradasD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="CerradasMultiplesD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="AbiertasD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="AbiertasMultiplesD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="OtrosD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="DemograficosD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
									<td>
										<asp:TextBox ID="PaginasD" runat="server" Width="60px" Text=" - " ReadOnly="true"></asp:TextBox>
									</td>
								</tr>
							</table>
							<br />
