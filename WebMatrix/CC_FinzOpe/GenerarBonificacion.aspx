<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/CAP_F.master" CodeBehind="GenerarBonificacion.aspx.vb" Inherits="WebMatrix.GenerarBonificacion" %>
                    ...
                    <div class="block">
                        <div class="form_left">
                            ...
                            <fieldset>
                                ...
                                <label>TipoContratacion</label>
                                <asp:TextBox ID="txtTipoContratacion" runat="server"></asp:TextBox>
                            </fieldset>
                            <fieldset>
                                <label>
                                    Fecha Ingreso</label>
                            ...
                            <fieldset class="validationGroup">
                                <div>
                                    <asp:GridView ID="gvProduccion" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        DataKeyNames="JobBook" EmptyDataText="No existen registros para mostrar">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NTrabajo" HeaderText="NTrabajo" />
                                            <asp:BoundField DataField="VrTotal" HeaderText="VrTotal" />
                                            <asp:BoundField DataField="VrBono" HeaderText="VrBono" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </fieldset>
