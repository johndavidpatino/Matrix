...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_OpcionesMenu" runat="server">
    <li><a title="MBO Gerencia" href="../MBO_Operaciones/CampoCalidadTotal.aspx">Calidad Total</a></li>
    ...
    <tr>
        <td style="width:25%; height: 99%;">
            <asp:GridView ID="GVCiudades" runat="server" AllowSorting="True" 
                                            ...
                                            HorizontalAlign="Left"><AlternatingRowStyle BackColor="White" /> <EditRowStyle BackColor="#2461BF" />
    ...
    <tr>
        <td style="width:25%; height: 99%;">
            <asp:GridView ID="GVCiudadesEmp" runat="server" AllowSorting="True" 
                                            CellPadding="4" 
                                            EnableSortingAndPagingCallbacks="True" Font-Size="Medium" ForeColor="#333333" 
                                            GridLines="None" style="font-size: small"><AlternatingRowStyle BackColor="White" ForeColor="#284775" />
