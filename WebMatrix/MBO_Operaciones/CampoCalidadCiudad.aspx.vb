...
Public Class CampoCalidadCiudad
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim IndiceTotalCiudadAdapter As New OperacionesTableAdapters.MBO_OPCampoIndiceTotalCiudadTableAdapter
        Dim IndiceTotalCiudadDataTable As New Operaciones.MBO_OPCampoIndiceTotalCiudadDataTable
        ...
        For I = 0 To WFilas - 1
            If Val(GVCiudades.Rows(I).Cells(3).Text) > 0 Then
                WIndice = Val(GVCiudades.Rows(I).Cells(3).Text) / Val(GVCiudades.Rows(I).Cells(2).Text) * 100
                GVCiudades.Rows(I).Cells(4).Text = Format(WIndice, "##0.00")
            Else
                WIndice = 0
                GVCiudades.Rows(I).Cells(4).Text = Format(WIndice, "##0.00")
            End If
        ...
        For I = 0 To GVCiudades.Rows.Count - 1
            WCiudad = GVCiudades.Rows(I).Cells(1).Text
            WMeta = 6.5
            WActual = Val(GVCiudades.Rows(I).Cells(4).Text)
            WMetaAction = 1.1 * WMeta
            WMetaWatch = WMetaAction
            WMetaBooster = WMeta
            If WActual < WMetaBooster Then
                xmlCiudades.Append("<set Label='" & GVCiudades.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='00FF00' />")
            Else
                If WActual < WMetaWatch Then
                    xmlCiudades.Append("<set Label='" & GVCiudades.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='FFFF10' />")
                Else
                    xmlCiudades.Append("<set Label='" & GVCiudades.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='FF0000'  />")
                End If
            End If
        Next
        ...
        For I = 0 To WFilas - 1
            If Val(GVCiudadesEmp.Rows(I).Cells(3).Text) > 0 Then
                WIndice = Val(GVCiudadesEmp.Rows(I).Cells(3).Text) / Val(GVCiudadesEmp.Rows(I).Cells(2).Text) * 100
        ...
        For I = 0 To GVCiudadesEmp.Rows.Count - 1
            WCiudad = GVCiudadesEmp.Rows(I).Cells(1).Text
            WMeta = 6.5
            WActual = Val(GVCiudades.Rows(I).Cells(4).Text)
            WMetaAction = 1.1 * WMeta
            WMetaWatch = WMetaAction
            WMetaBooster = WMeta
            If WActual < WMetaBooster Then
                xmlCiudades.Append("<set Label='" & GVCiudadesEmp.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='00FF00' />")
            Else
                If WActual < WMetaWatch Then
                    xmlCiudades.Append("<set Label='" & GVCiudadesEmp.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='FFFF10' />")
                Else
                    xmlCiudades.Append("<set Label='" & GVCiudadesEmp.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='FF0000' />")
                End If
            End If
        Next
        xmlCiudades.Append("</chart>")
        ...
        For I = 0 To WFilas - 1
            If Val(GVCiudadesCon.Rows(I).Cells(3).Text) > 0 Then
                WIndice = Val(GVCiudadesCon.Rows(I).Cells(3).Text) / Val(GVCiudadesCon.Rows(I).Cells(2).Text) * 100
                GVCiudadesCon.Rows(I).Cells(4).Text = Format(WIndice, "##0.00")
            Else
                WIndice = 0
                GVCiudadesCon.Rows(I).Cells(4).Text = Format(WIndice, "##0.00")
            End If
        ...
        For I = 0 To GVCiudadesCon.Rows.Count - 1
            WCiudad = GVCiudadesCon.Rows(I).Cells(1).Text
            WMeta = 6.5
            WActual = Val(GVCiudades.Rows(I).Cells(4).Text)
            WMetaAction = 1.1 * WMeta
            WMetaWatch = WMetaAction
            WMetaBooster = WMeta
            If WActual < WMetaBooster Then
                xmlCiudades.Append("<set Label='" & GVCiudadesCon.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='00FF00' />")
            Else
                If WActual < WMetaWatch Then
                    xmlCiudades.Append("<set Label='" & GVCiudadesCon.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='FFFF10' />")
                Else
                    xmlCiudades.Append("<set Label='" & GVCiudadesCon.Rows(I).Cells(1).Text & "' value='" & Val(GVCiudades.Rows(I).Cells(4).Text) & "' color='FF0000' />")
                End If
            End If
        Next
        xmlCiudades.Append("</chart>")
    ...
    Private Sub CargarDatos()
        Dim IndiceMesCiudadAdapter As New OperacionesTableAdapters.MBO_OPCampoIndiceMesCiudadTableAdapter
        Dim IndiceMesCiudadDataTable As New Operaciones.MBO_OPCampoIndiceMesCiudadDataTable
        Dim IndiceMesCiudadRow As Operaciones.MBO_OPCampoIndiceMesCiudadRow
