<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/PY_F.master" 
    CodeBehind="InHomeVisit.aspx.vb" Inherits="WebMatrix.InHomeVisit" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_ContentForm" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upDatos">
        <ContentTemplate>
        <p style="color: White;">Listado de In Home Visit del Trabajo</p>
        <div class="actions">
        <div class="actions">
        ...
        <asp:HiddenField ID="hfIdInHome" runat="server" />
        <asp:HiddenField ID="hfNumeroInHome" runat="server" />
        <asp:HiddenField ID="hfEstado" runat="server" />
        <asp:HiddenField ID="hfTipo" Value="0" runat="server" />
        <asp:GridView ID="gvInHome" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="10"
            CssClass="displayTable" AlternatingRowStyle-CssClass="odd" PagerStyle-CssClass="headerfooter ui-toolbar"
            DataKeyNames="Id,CiudadId,IdModerador,IdEstado" AllowPaging="True" EmptyDataText="No existen In Home para mostrar">
                    ...
                    <asp:TemplateField HeaderText="Reemplazar" ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgReemplazar" runat="server" CausesValidation="False" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" 
                                CommandName="Reemplazar" ImageUrl="~/Images/select_16.png" Text="Reemplazar" ToolTip="Reemplazar In Home" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                            ...
                            <tr>
                                <td>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument="First" CommandName="Page"
                                        Enabled='<%# IIf(gvInHome.PageIndex = 0, "false", "true") %>' SkinID="Paging">« Primero</asp:LinkButton>
                                </td>
                                <td>
                                    <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument="Prev" CommandName="Page"
                                        Enabled='<%# IIf(gvInHome.PageIndex = 0, "false", "true") %>' SkinID="paging">&lt; Anterior</asp:LinkButton>
                                </td>
                                <td>
                                    <span class="pagingLinks">[<%= gvInHome.PageIndex + 1%>-<%= gvInHome.PageCount%>]</span>
                                </td>
                                <td>
                                    <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument="Next" CommandName="Page"
                                        Enabled='<%# IIf((gvInHome.PageIndex + 1) = gvInHome.PageCount, "false", "true") %>'
        ...
        <div class="actions">
        <asp:Panel ID="pnlNewInHome" runat="server" Visible="false">
        
            <h4>Nuevo In Home Visit</h4>
            <div class="form_left">
                <fieldset>
            ...
            <div class="form_left">
                <fieldset>
                    <label>Número Participantes por In Home</label>
        ...
        <div class="actions">
        <p style="color: White;">Detalles de In Home Visit del Trabajo</p>
        <asp:GridView ID="gvDetalles" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            DataKeyNames="Id,IdSesion,IdUsuario,IdEstado" AllowPaging="True" EmptyDataText="No existen Detalles para mostrar">
                ...
                <AlternatingRowStyle CssClass="odd" />
                <Columns>
                    <asp:BoundField DataField="Numero" HeaderText="Número InHome"/>
            ...
            <asp:Button ID="btnvolver" runat="server" Text="Volver a In Home" />
            <br>
            </br>
            </div>
        </asp:Panel>
    ...
    <div id="GuardarObservacion">
        <asp:UpdatePanel ID="upObservacion" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <label>Razones de Cambio de Estado del In Home Visit</label>
