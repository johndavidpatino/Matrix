<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterProyectos.master"
    CodeBehind="AsignacionProyectos.aspx.vb" Inherits="WebMatrix.AsignacionProyectos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>Asignación Gerente de Proyectos</a>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_ComentFormulario" runat="server">
    En este formulario puede asignar los gerentes de proyectos para su ejecución
    <br />
</asp:Content>
            ...
            <div id="error" class="error_message ui-state-error ui-corner-all" style="display: none;">
                ...
                <asp:Panel runat="server" id="accordion0">
                    <h3 style="float:left; text-align:left;">
                        <a>
                            <label>
                                Proyectos<asp:HiddenField ID="hfIdProyecto" runat="server" />
                        ...
                        <asp:GridView ID="gvProyectos" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <asp:Panel runat="server" id="BriefCuentasProyectos" Visible="false">
                    <h3 style="float:left; text-align:left;">
                        <a>
                            <label>
                    ...
                    <div class="block">
                        ...
                        <asp:Panel ID="pnlBrief" runat="server">
                            ...
                            <fieldset>
                                <label>
                                    Información de la Propuesta</label>
                            </fieldset>
                            <div class="actions">
