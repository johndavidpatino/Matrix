<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AnuncioAprobacionConValorCorreccion.aspx.vb" Inherits="WebMatrix.Emails_AnuncioAprobacionConValorCorreccion" %>
...
<body>
    ...
    <div>
        <asp:Label ID="lblAsunto" Text="Matrix: Corrección Anuncio de Aprobación" runat="server"></asp:Label>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size:12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;color:#333333;">
                <p style="margin:0 0 0 0;padding:0 0 0 0;">Se han realizado cambios al estudio en referencia y estas son las principales características:</p>
