<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CircularCargada.aspx.vb" Inherits="WebMatrix.Emails_CircularCargada" %>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size: 12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;
                ...
                <p style="margin: 0 0 0 0; padding: 0 0 0 0;">
                    ...
                    Ha sido cargada una nueva circular para el Trabajo en mención. Para visualizarla, diríjase a la opción de Listado de documentos<br /><br />
