...
Public Class EntregaTrabajoObservaciones
...
#Region "Eventos"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("idFicha") IsNot Nothing Then
            ...
            Me.hplLink.NavigateUrl = WebMatrix.Util.obtenerUrlRaiz() & "/OP_Cualitativo/FichaObservacion.aspx?idtrabajo=" & estudio
...
#Region "Funciones y Metodos"
    Sub CargarElemento(ByVal TrabajoId As Long)
        ...
        Dim info = oEntrega.DevolverPreEntregaxTrabajoCuali(TrabajoId)
