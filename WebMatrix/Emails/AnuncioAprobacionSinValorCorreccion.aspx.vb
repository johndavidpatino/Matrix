...
Public Class Emails_AnuncioAprobacionSinValorCorreccion
...
#Region "Funciones y Metodos"
    Sub CargarElemento(ByVal EstudioId As Long)
        ...
        lblDocumentoSoporte.Text = info.DocumentoSoporte
        lblTiempoRetencion.Text = info.TiempoRetencionAnnos
    ...
    Sub GenerarHtml()
        ...
        Dim o As New Reportes.DestinatariosCorreos
        Dim estudio As Int64 = Int64.Parse(Request.QueryString("idEstudio").ToString())
        For i As Integer = 0 To o.AnuncioAprobacionSinValor(estudio).Count - 1
            destinatarios.Add(o.AnuncioAprobacionSinValor(estudio).Item(i).CORREO)
        Next
