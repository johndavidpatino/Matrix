<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PonderacionCargada.aspx.vb" Inherits="WebMatrix.Emails_PonderacionCargada" %>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size: 12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;
                ...
                <p style="margin: 0 0 0 0; padding: 0 0 0 0;">
                    ...
                    Ha sido cargado un nuevo archivo de Ponderación para el Trabajo en mención. Para visualizarla, diríjase a la opción de Listado de documentos<br /><br />
