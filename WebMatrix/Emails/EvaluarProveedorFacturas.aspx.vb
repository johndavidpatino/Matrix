...
Public Class EvaluarProveedorFacturas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Request.QueryString("IdFactura") Is Nothing Then
            If Int64.TryParse(Request.QueryString("IdFactura"), idFactura) Then
                Me.hplLink.NavigateUrl = WebMatrix.Util.obtenerUrlRaiz() & "/FI_AdministrativoFinanciero/Evaluacion-Proveedor-Facturas.aspx"
                ...
                ElseIf Factura.Tipo = eTipoOrden.requerimiento Then
...
#Region "Metodos"
    ...
    Function obtenerUsuariosNotificacion() As List(Of String)
        ...
        If FacturaDetalle IsNot Nothing Then
            lstUsuarios.AddRange(daFacturas.ObtenerLogEvaluacionesProveedorFactura(Factura.id).Where(Function(x) x.FechaEvaluacion Is Nothing).Select(Function(x) x.Email).Distinct().ToList)
        Else
