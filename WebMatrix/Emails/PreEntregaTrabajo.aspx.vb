...
#Region "Funciones y Metodos"
    ...
    Sub GenerarHtml()
        ...
        Next
        'destinatarios.Add("Alexandra.Vargas@ipsos.com")
        'destinatarios.Add("Jacobo.Rodriguez@ipsos.com")
        'destinatarios.Add("Angie.Guerrero@ipsos.com")
        'destinatarios.Add("Monica.Castro@ipsos.com")
