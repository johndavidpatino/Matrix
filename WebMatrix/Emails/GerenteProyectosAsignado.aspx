    ...
    <div>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size:12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;color:#333333;">
                <p style="margin:0 0 0 0;padding:0 0 0 0;">Ha sido asignado el gerente de proyectos <asp:Label ID="lblGerenteProyectos" runat="server"></asp:Label> al proyecto: <asp:Label ID="lblProyecto" runat="server"></asp:Label></p><br /><br />
                <p style="margin:0 0 0 0;padding:0 0 0 0;">El gerente de cuentas de este proyecto es:  <asp:Label ID="lblGerenteCuentas" runat="server"></asp:Label><br /><br />
