<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NuevoProyectoJBI.aspx.vb" Inherits="WebMatrix.Emails_NuevoProyectoJBI" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size:12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;color:#333333;">
                <p style="margin:0 0 0 0;padding:0 0 0 0;">Ha sido creado un nuevo proyecto para asignación de JobBook Interno con nombre: <asp:Label ID="lblProyecto" runat="server"></asp:Label></p><br />
