...
Public Class Emails_AnuncioAprobacionConValorCorreccion
...
#Region "Funciones y Metodos"
    ...
    Sub GenerarHtml()
        ...
        Dim estudio As Int64 = Int64.Parse(Request.QueryString("idEstudio").ToString())
        For i As Integer = 0 To o.AnuncioAprobacionConValor(estudio).Count - 1
            destinatarios.Add(o.AnuncioAprobacionConValor(estudio).Item(i).CORREO)
        Next
