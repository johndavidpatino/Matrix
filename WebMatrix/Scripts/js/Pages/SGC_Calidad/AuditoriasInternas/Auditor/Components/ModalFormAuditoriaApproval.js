...
import { SGC_AI_Auditor_FormAuditoriaApproval } from './FormAuditoriaApproval.js'

export class SGC_AI_Auditor_ModalFormAuditoriaApproval extends LitElement {
    static properties = {
        ...
        return html`
            ...
            >
                <div class="mx-sgc-ai-auditor-form-auditoria">
                    <mx-sgc-ai-auditor-form-auditoria-approval
...
customElements.define('mx-sgc-ai-auditor-modal-form-auditoria-approval', SGC_AI_Auditor_ModalFormAuditoriaApproval)