...
export class SGC_AI_Auditor_FormAuditoria extends LitElement {
    static properties = {
    ...
    async HandleBtnClick(event) {
        if (this.isValid()) {
            ...
            await SGC_AuditoriasInternasService.AuditoriaInformeAuditorAdd(
                {
...
customElements.define('mx-sgc-ai-auditor-form-auditoria', SGC_AI_Auditor_FormAuditoria)