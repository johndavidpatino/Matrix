...
import { SGC_AI_Auditor_FormAuditoria } from './FormAuditoria.js'

export class SGC_AI_Auditor_ModalFormAuditoria extends LitElement {
    static properties = {
...
customElements.define('mx-sgc-ai-auditor-modal-form-auditoria', SGC_AI_Auditor_ModalFormAuditoria)