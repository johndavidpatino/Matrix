<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MPPresupuestosInternos.master" CodeBehind="RevisionProductividadMYSCall.aspx.vb" Inherits="WebMatrix.RevisionProductividadMYSCall" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="SideBar" runat="server">
    ...
    <li>
        <a href="../op_cuantitativo/ProductividadRevisadaMYSCall.aspx" class="nav-link">
            <i class="metismenu-icon fa fa-table"></i>
            Productividad revisada MYS-Call
        </a>
    </li>
    <li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Title" runat="server">
    Revisión productividad para el corte actual - Mystery / Call Center
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="SubTitle" runat="server">
    Aquí se pueden ver las los registros de productividad sincronizados para el presente corte de Mystery / Call Center del <strong>
                    ...
                    <asp:GridView ID="gvDataSearch" runat="server" AutoGenerateColumns="false" DataKeyNames="id" CssClass="mb-0 table table-hover" BorderStyle="NotSet" BorderWidth="0" EmptyDataText="No hay registros">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="# Encuestas">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtCantidad" Text='<%# IIf(IsNumeric(Eval("CantidadCoordinador")), Eval("CantidadCoordinador"), Eval("Cantidad")) %>' runat="server" Width="50px"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
