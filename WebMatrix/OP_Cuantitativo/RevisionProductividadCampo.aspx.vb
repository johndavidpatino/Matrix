...
Public Class RevisionProductividadCampo
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim permisos As New Datos.ClsPermisosUsuarios
        Dim UsuarioID As Int64 = Int64.Parse(Session("IDUsuario").ToString())
        If permisos.VerificarPermisoUsuario(156, UsuarioID) = False Then
    ...
    Sub CargarTrabajos()
        ...
        If Now.Month = 1 Then inicioCorteFecha = DateAdd(DateInterval.Year, -1, inicioCorteFecha)
        Dim finCorteFecha = New DateTime(Now.Year, Now.Month, 15)
        ddlTrabajoSeleccionado.DataSource = op.CuantiProdProductividadTrabajos_Get(inicioCorteFecha, finCorteFecha, Nothing, Nothing, Nothing, 2, Nothing, False, Nothing, Nothing)
    ...
    Sub CargarStatus()
        ...
        Dim finCorteFecha = New DateTime(Now.Year, Now.Month, 15)
        Dim op As New OP_CuantiDapper
        gvEstatus.DataSource = op.CuantiProdProductividadStatus_Get(inicioCorteFecha, finCorteFecha, Nothing, Nothing, Nothing, 2, Nothing, False, Nothing)
        gvEstatus.DataBind()
    End Sub
    ...
    Sub CargarGrid()
        ...
        Dim op As New OP_CuantiDapper
        gvDataSearch.DataSource = op.CuantiProdProductividad_Get(inicioCorteFecha, finCorteFecha, Nothing, Nothing, ddlTrabajoSeleccionado.SelectedValue, 2, Nothing, False, Nothing, Nothing)
