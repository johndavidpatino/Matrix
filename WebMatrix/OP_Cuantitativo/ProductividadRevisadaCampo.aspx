<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MPPresupuestosInternos.master" CodeBehind="ProductividadRevisadaCampo.aspx.vb" Inherits="WebMatrix.ProductividadRevisadaCampo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="SideBar" runat="server">
    ...
    <li>
        <a href="../op_cuantitativo/RevisionProductividadCampo.aspx" class="nav-link">
            <i class="metismenu-icon fa fa-table"></i>
            Revisar productividad Campo
        </a>
    </li>
    <li>
