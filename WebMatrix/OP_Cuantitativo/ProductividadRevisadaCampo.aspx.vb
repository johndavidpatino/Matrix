...
Public Class ProductividadRevisadaCampo
    ...
    Sub CargarTrabajos()
        ...
        If Now.Month = 1 Then inicioCorteFecha = DateAdd(DateInterval.Year, -1, inicioCorteFecha)
        Dim finCorteFecha = New DateTime(Now.Year, Now.Month, 15)
        ddlTrabajoSeleccionado.DataSource = op.CuantiProdProductividadTrabajos_Get(inicioCorteFecha, finCorteFecha, Nothing, Nothing, Nothing, 2, Nothing, True, Nothing, Nothing)
    ...
    Sub CargarGrid()
        ...
        Dim op As New OP_CuantiDapper
        gvDataSearch.DataSource = op.CuantiProdProductividad_Get(inicioCorteFecha, finCorteFecha, Nothing, Nothing, ddlTrabajoSeleccionado.SelectedValue, 2, Nothing, True, Nothing, Nothing)
