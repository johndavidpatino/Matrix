<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MPPresupuestosInternos.master" CodeBehind="ProductividadRevisadaCoordinador.aspx.vb" Inherits="WebMatrix.ProductividadRevisadaCoordinador" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="SubTitle" runat="server">
    Aquí se pueden ver las los registros de productividad que fueron aprobados por el coordinador para el corte del <strong>
