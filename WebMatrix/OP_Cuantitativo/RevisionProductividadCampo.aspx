<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MPPresupuestosInternos.master" CodeBehind="RevisionProductividadCampo.aspx.vb" Inherits="WebMatrix.RevisionProductividadCampo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="SideBar" runat="server">
    ...
    <li>
        <a href="../op_cuantitativo/ProductividadRevisadaCampo.aspx" class="nav-link">
...
<asp:Content ID="Content4" ContentPlaceHolderID="Title" runat="server">
    Revisión productividad para el corte actual - CAMPO
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="SubTitle" runat="server">
    Aquí se pueden ver las los registros de productividad sincronizados para el presente corte de CAMPO del <strong>
