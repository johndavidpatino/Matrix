<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MPPresupuestosInternos.master" CodeBehind="PlanillasCargadas.aspx.vb" Inherits="WebMatrix.PlanillasCargadas" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Title" runat="server">
    Planillas cargadas para el corte actual
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="SubTitle" runat="server">
    Aquí se pueden ver las plantillas que se han cargado para el presente corte
</asp:Content>
