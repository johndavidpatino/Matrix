...
Public Class ProductividadRevisadaCoordinador
    ...
    Sub CargarTrabajos()
        ...
        If Now.Month = 1 Then inicioCorteFecha = DateAdd(DateInterval.Year, -1, inicioCorteFecha)
        Dim finCorteFecha = New DateTime(Now.Year, Now.Month, 15)
        ddlTrabajoSeleccionado.DataSource = op.CuantiProdProductividadTrabajos_Get(inicioCorteFecha, finCorteFecha, Session("IDUsuario").ToString, Nothing, Nothing, Nothing, True, Nothing, Nothing, Nothing)
    ...
    Sub CargarGrid()
        ...
        Dim op As New OP_CuantiDapper
        gvDataSearch.DataSource = op.CuantiProdProductividad_Get(inicioCorteFecha, finCorteFecha, Session("IDUsuario").ToString, Nothing, ddlTrabajoSeleccionado.SelectedValue, Nothing, True, Nothing, Nothing, Nothing)
