<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/OPQ_F.master" CodeBehind="Captura.aspx.vb" Inherits="WebMatrix.Captura" %>
...
<h3><a href="#"><label>Captura</label></a></h3><br />
...
<label>Unidad a enviar:</label>
    <asp:DropDownList ID="ddlUnidad" runat="server" >
        <asp:ListItem Value="20">Verificación</asp:ListItem>
    </asp:DropDownList>
</div>
<div class="actions">
