<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/CU_F.master"
    CodeBehind="ListadoPropuestas.aspx.vb" Inherits="WebMatrix.FI_ListadoPropuestas" %>
                    ...
                    <div class="block">
                        <div class="form_left">
                            <fieldset>
                                ...
                                <label>Gerente de Cuentas</label>
                                <asp:DropDownList ID="ddlGerenteCuentas" runat="server"></asp:DropDownList>
                                <label>Estado</label>
                                <asp:DropDownList ID="ddlEstado" runat="server"></asp:DropDownList>
                                <asp:Button ID="btnBuscar" runat="server" Text="Buscar" /><asp:HiddenField ID="hfidPropuesta" runat="server" />
                            </div>
                            </fieldset>
                        </div>
                        <asp:UpdatePanel ID="upEstudios" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="gvEstudios" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="Id" HeaderText="No. Propuesta" />
