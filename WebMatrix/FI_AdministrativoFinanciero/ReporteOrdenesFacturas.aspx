<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/RP_F.master" CodeBehind="ReporteOrdenesFacturas.aspx.vb" Inherits="WebMatrix.ReporteOrdenesFacturas" %>
        ...
        <ContentTemplate>
            <div style="width: 45%; float: left; border: double">
                <fieldset class="validationGroup">
                    <legend>Filtro de ordenes de servicio</legend>
                    <fieldset>
                        <asp:Label ID="lblIdOrden" runat="server" Text="Id Orden" AssociatedControlID="txtIdOrden"></asp:Label>
                        <asp:TextBox ID="txtIdOrden" runat="server" TextMode="Number"> </asp:TextBox>
                    </fieldset>
                    <fieldset>
                        <asp:Label ID="lblTipoOrden" runat="server" AssociatedControlID="ddlTipoOrden" Text="Tipo Orden"></asp:Label>
                        <asp:DropDownList ID="ddlTipoOrden" runat="server">
                            <asp:ListItem Value="-1" Text="Seleccione"></asp:ListItem>
                            <asp:ListItem Value="1" Text="Orden de Servicio"></asp:ListItem>
                            <asp:ListItem Value="2" Text="Orden de Compra"></asp:ListItem>
                            <asp:ListItem Value="3" Text="Requerimiento de Servicio"></asp:ListItem>
                        </asp:DropDownList>
                    </fieldset>
                    <fieldset>
                    ...
                    <div>
                        <label>Ordenes creadas entre las fechas:</label>
                        <div style="float: left; margin-right: 5px">
                            <fieldset>
                                <label>
                                    Fecha Inicio
                                </label>
                                <asp:TextBox ID="txtOrdenFechaInicio" runat="server"> </asp:TextBox>
                            </fieldset>
                        </div>
                        <div style="float: left">
                            <fieldset>
                                ...
                                <asp:TextBox ID="txtOrdenFechaFin" runat="server"> </asp:TextBox>
                            </fieldset>
                        </div>
                    </div>
                </fieldset>
            </div>
            <div style="width: 50%; float: left; border: double">
                <fieldset class="validationGroup">
        ...
        <ContentTemplate>
            <asp:GridView ID="gvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FechaCreacionOrden" HeaderText="Fecha Creacion Orden"
                        DataFormatString="{0:dd/MM/yyyy}" />
                    <asp:BoundField DataField="Beneficiario" HeaderText="Beneficiario" />
                    <asp:BoundField DataField="UsuarioEvalua" HeaderText="Usuario Evalua Factura" />
                    <asp:BoundField DataField="TipoDetalle" HeaderText="Tipo" />
                    ...
                    <asp:BoundField DataField="JobBookCodigo" HeaderText="JobBook Codigo" />
                    <asp:BoundField DataField="JobBookNombre" HeaderText="JobBook Nombre" />
                    <asp:BoundField DataField="TipoOrden" HeaderText="Tipo Orden" Visible="false" />
                    <asp:BoundField DataField="TipoTexto" HeaderText="Tipo Orden" />
                    <asp:BoundField DataField="Estado" HeaderText="Estado" />
                    <asp:BoundField DataField="ObservacionAnulacion" HeaderText="Observación Anulación" />
