<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterREP.master" CodeBehind="ReportesMedicionProgramaProyectos.aspx.vb" Inherits="WebMatrix.ReportesMedicionProgramaProyectos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#accordionDataDetGerente').accordion({
            ...
            $('#accordionDataGerente').accordion({
                change: function (event, ui) { $('html, body').animate({ scrollTop: 0 }, 'slow'); },
                header: "h2",
                fillSpace: true,
                collapsible: true,
            ...
            $('#accordionDataDetResponsable').accordion({
                change: function (event, ui) { $('html, body').animate({ scrollTop: 0 }, 'slow'); },
                header: "h2",
                fillSpace: true,
                collapsible: true,
            ...
            $('#accordionDataResponsable').accordion({
                change: function (event, ui) { $('html, body').animate({ scrollTop: 0 }, 'slow'); },
                header: "h2",
                fillSpace: true,
                collapsible: true,
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_Content" runat="server">
    ...
    <div style="margin-top: 30px">
        <div id="accordionDataGerente">
            <h2>Datos Agrupados por Gerente de Proyectos</h2>
            <div style="max-width: 100%; min-height: 300px;">
                <asp:UpdatePanel runat="server" ID="updDatos" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatosGerente" runat="server" AutoGenerateColumns="true"></asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        ...
        <br />
        <div id="accordionDataDetGerente">
            <h2>Detalles por Gerente de Proyectos</h2>
            <div style="max-width: 100%; min-height: 500px; max-height: 500px;">
                <asp:Button Text="Exportar a Excel" runat="server" ID="btnExcelDetalleGerente" />
                <br />
                <br />
                <br />
                <asp:UpdatePanel runat="server" ID="updDatosDetalle" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatosDetalleGerente" runat="server" AutoGenerateColumns="true"></asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
    ...
    <div style="margin-top: 30px">
        <div id="accordionDataResponsable">
            <h2>Datos Agrupados por Responsable Tarea</h2>
            <div style="max-width: 100%; min-height: 300px;">
                <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatosResponsable" runat="server" AutoGenerateColumns="true"></asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        ...
        <br />
        <div id="accordionDataDetResponsable">
            <h2>Detalles</h2>
            <div style="max-width: 100%; min-height: 500px; max-height: 500px;">
                <asp:Button Text="Exportar a Excel" runat="server" ID="btnExcelDetalleResponsable" />
                <br />
                <br />
                <br />
                <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatosDetalleResponsable" runat="server" AutoGenerateColumns="true"></asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        ...
        <div id="accordionDataDetCOE">
            ...
            <div style="max-width: 100%; min-height: 500px; max-height: 500px;">
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel4" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatosDetalleCOE" runat="server" AutoGenerateColumns="true"></asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
