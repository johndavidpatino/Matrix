<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterReportes.master" AsyncTimeout="180"
    CodeBehind="AsignacionYEjecucionCampo.aspx.vb" Inherits="WebMatrix.AsignacionYEjecucionCampo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>Asignacion Y Ejecucion de Campo</a>
</asp:Content>
                ...
                <div id="accordion0">
                    <h3 style="float: left; text-align: left;">
                        Asignación y Ejecución
                            ...
                            <asp:TextBox ID="txtFechaTerminacion" runat="server" CssClass="required text textEntry"></asp:TextBox>
                            <label>
                                Gerencias OP</label>
                            <asp:CheckBoxList ID="chbGerencias" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                            </asp:CheckBoxList>
                            <div class="spacer"></div>
                                <asp:Button ID="btnMostrar" runat="server" Text="Ver Reporte" CssClass="causesValidation" />
                                <asp:Button ID="btnExportar" runat="server" Text="Exportar a Excel" CssClass="causesValidation" />
                        </div>
                    <div class="spacer"></div>
                        <asp:GridView ID="gvDatos" runat="server" Width="100%" PageSize="10" AllowPaging="True"
                            ...
                            <AlternatingRowStyle CssClass="odd" />
                            <PagerTemplate>
                                <div class="pagingButtons" style="float: left">
                                    <table>
                                        <tr>
                                            <td>
