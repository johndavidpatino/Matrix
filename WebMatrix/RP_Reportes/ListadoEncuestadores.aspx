<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterReportes.master" CodeBehind="ListadoEncuestadores.aspx.vb" Inherits="WebMatrix.ListadoEncuestadores" %>
            ...
            <div>
                ...
                <asp:GridView ID="gvContratacion" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TipoEncuestador" HeaderText="Tipo de encuestador" />
                        <asp:BoundField DataField="DivMuniNombre" HeaderText="Ciudad" />
                        <asp:BoundField DataField="TipoContratacionTexto" HeaderText="Tipo Contratación" />
