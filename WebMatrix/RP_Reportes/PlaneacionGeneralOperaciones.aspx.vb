...
Public Class REP_PlaneacionGeneralOperaciones
...
#End Region
    ...
    Protected Sub btnMostrar_Click(sender As Object, e As EventArgs) Handles btnMostrar.Click
        If (Me.chPropuestas.Checked = False And Me.chEstudios.Checked = False And Me.chTrabajos.Checked = False) Or (Me.rblVer.SelectedIndex = -1) Then
            ShowNotification("Debe seleccionar por lo menos una opción", ShowNotifications.ErrorNotification)
    ...
    Protected Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=ExportPlaneacionGeneralOperaciones.xls")
