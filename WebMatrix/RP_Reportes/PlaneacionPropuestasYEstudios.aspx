<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/RP_F.master" CodeBehind="PlaneacionPropuestasYEstudios.aspx.vb" Inherits="WebMatrix.PlaneacionPropuestasYEstudios" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>Planeacion Estudios sin Entregar y Propuestas Alta Probabilidad</a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion0">
                    <h3>
                        <a href="#">
                            <label>
                                Estudios sin entregar y Propuestas alta probabilidad<asp:HiddenField ID="hfidTrabajo" runat="server" />
                            </label>
                        </a>
                    </h3>
                    <div class="block">
        ...
        <asp:UpdatePanel ID="UPanelExport" runat="server" ChildrenAsTriggers="false"
            ...
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="SqlDsExport" runat="server" 
                    ...
                    SelectCommand="OP_PL_PivotPropyEst" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                ...
                <asp:SqlDataSource ID="SqlDsExportCantidades" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:MatrixConnectionString %>" 
                    SelectCommand="OP_PL_PropyEst_Datos" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="hfGraficaDatos" Name="GRAFICA" 
                            PropertyName="Value" Type="Int32" />
                        <asp:ControlParameter ControlID="ddlGerencias" Name="GERENCIA" 
                ...
                <asp:SqlDataSource ID="SqlDsExportRecursos" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:MatrixConnectionString %>" 
                    SelectCommand="OP_PL_PropyEstRecursos_Datos" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="hfGraficaDatos" Name="GRAFICA" 
                            PropertyName="Value" Type="Int32" />
                        <asp:ControlParameter ControlID="ddlGerencias" Name="GERENCIA" 
