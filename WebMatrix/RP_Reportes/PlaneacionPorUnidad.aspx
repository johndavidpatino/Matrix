<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/RP_F.master" CodeBehind="PlaneacionPorUnidad.aspx.vb" Inherits="WebMatrix.PlaneacionPorUnidad" EnableViewState="false" %>

<%@ Register Assembly="DevExpress.XtraCharts.v22.2.Web, Version=22.2.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraCharts.Web" TagPrefix="dxchartsui" %>
<%@ Register assembly="DevExpress.XtraCharts.v22.2, Version=22.2.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.XtraCharts" tagprefix="cc1" %>
<%@ Register assembly="DevExpress.Web.v22.2, Version=22.2.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Data.Linq" tagprefix="dx" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_ContentForm" runat="server">
    ...
    <asp:DropDownList ID="ddlUnidades" runat="server">
        ...
        <asp:ListItem Text="Connect" Value="1"></asp:ListItem>
        <asp:ListItem Text="Marketing" Value="2"></asp:ListItem>
        <asp:ListItem Text="Public Affairs" Value="4"></asp:ListItem>
    </asp:DropDownList>
    ...
    <asp:SqlDataSource ID="SqlDsData" runat="server" ConnectionString="<%$ ConnectionStrings:MatrixConnectionString %>" SelectCommand="REP_GanttPlaneacionAll" SelectCommandType="StoredProcedure">
        <SelectParameters>
