<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterReportes.master"
    CodeBehind="ListadoPropuestasSeguimiento.aspx.vb" Inherits="WebMatrix.ListadoPropuestasSeguimiento" %>
                ...
                <div id="accordion0">
                    ...
                    <div>
                        ...
                        <div class="spacer"></div>
                            ...
                            <asp:ImageButton ID="btnImgExportar" runat="server" ImageUrl="~/Images/excel.jpg" Height="5%" Width="5%" Visible="false" />
                            <br />
                            <asp:GridView ID="gvPropuestas" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                                ...
                                AllowPaging="true" EmptyDataText="No existen registros para mostrar" DataKeyNames="Id" >
