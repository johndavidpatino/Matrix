...
Public Class AvanceDeCampoDialog
    Inherits System.Web.UI.Page

#Region "Eventos"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Session("TrabajoId") IsNot Nothing Then
    ...
    End Sub
    Protected Sub ddVariables_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddVariables.SelectedIndexChanged
        Me.gvAvanceCuotas.DataBind()
        ActivateAccordion(2, EffectActivateAccordion.SlideEffect)
    End Sub

    Protected Sub ddColumna_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddColumna.SelectedIndexChanged
    ...
    Protected Sub ddFila_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddFila.SelectedIndexChanged
        If Me.ddFila.SelectedValue = 0 Or Me.ddColumna.SelectedValue = 0 Then
            ActivateAccordion(3, EffectActivateAccordion.SlideEffect)
            Exit Sub
        Else
...
#End Region
    ...
    End Sub
    Private Sub ddlAreasTrafico_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlAreasTrafico.SelectedIndexChanged
