...
Public Class PlaneacionPropuestas
...
#Region "Campo"
    Sub GraficoEncuestas()
        ...
        Dim info = o.PlaneacionPropuestasAltaEncuestas(Gerencia, Unidad, Metodologia, Ciudad)
    ...
    Sub GraficoEncuestadores()
        ...
        Dim Ciudad As Int32? = Nothing
        VariablesConsulta(Gerencia, Unidad, Metodologia, Ciudad)
        Dim info = o.PlaneacionPropuestasAltaEncuestadores(Gerencia, Unidad, Metodologia, Ciudad)
        For Each element In info.GroupBy(Function(x) x.PERIODO)
            Dim serie As New Series
            serie.Name = element.Key
            serie.ChartType = SeriesChartType.Line
...
#End Region
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=ExportadoPropAltaProb.xls")
