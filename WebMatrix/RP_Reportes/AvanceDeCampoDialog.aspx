<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/DialogMaster.master"
    CodeBehind="AvanceDeCampoDialog.aspx.vb" Inherits="WebMatrix.AvanceDeCampoDialog" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_Section" runat="server">
    <asp:UpdatePanel ID="upDatos" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDsExportado" runat="server" 
            ...
            SelectCommand="SELECT Res_Id, E_Id, Res_Numero, Per_NumIdentificacionEncu, Per_NumIdentificacionSup, Res_IDM, Res_Ciudad, Res_Fecha, Res_Libre1, Res_Libre2, Res_Libre3, Res_Libre4, Res_Libre5, Res_Libre6, Res_Libre7, Res_Libre8, Res_Libre9, Res_Libre10, Usuario, Fecha, Anulada=CASE WHEN Anulada='TRUE' THEN 1 ELSE 0 END, Obs_Anulacion, Per_anulo FROM GestionCampo.dbo.Respuestas WHERE (E_Id = @CAP)">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfidTrabajo" Name="CAP" PropertyName="Value" />
            </SelectParameters>
        </asp:SqlDataSource>
                ...
                <div id="accordion10">
                    ...
                    <div class="block">
                        <asp:GridView ID="gvEncuestadores" runat="server" AutoGenerateColumns="False" CellSpacing="4" CssClass="centerGridView" 
