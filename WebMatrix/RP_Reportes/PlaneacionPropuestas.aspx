<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/RP_F.master" CodeBehind="PlaneacionPropuestas.aspx.vb" Inherits="WebMatrix.PlaneacionPropuestas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>Planeacion Propuestas Alta Probabilidad</a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion0">
                    <h3>
                        <a href="#">
                            <label>
                                Propuestas con alta probabilidad<asp:HiddenField ID="hfidTrabajo" runat="server" />
                            </label>
                        </a>
                    </h3>
                    <div class="block">
        ...
        <asp:UpdatePanel ID="UPanelExport" runat="server" ChildrenAsTriggers="false"
            ...
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="SqlDsExport" runat="server" 
                    ...
                    SelectCommand="OP_PL_PivotPropuestasAltaProbabilidad" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                ...
                <asp:GridView ID="gvExportCantidades" runat="server" Width="100%" Visible="false"
                            CssClass="displayTable" AlternatingRowStyle-CssClass="odd" 
                    PagerStyle-CssClass="headerfooter ui-toolbar" 
                ...
                <asp:SqlDataSource ID="SqlDsExportCantidades" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:MatrixConnectionString %>" 
                    SelectCommand="OP_PL_PropuestasAltaProbabilidadEncuestas_Datos" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlGerencias" Name="GERENCIA" 
                            PropertyName="SelectedValue" Type="Int64" />
                        <asp:ControlParameter ControlID="ddlUnidades" Name="UNIDAD" 
                ...
                <asp:GridView ID="gvExportRecursos" runat="server" Width="100%" Visible="false"
                            CssClass="displayTable" AlternatingRowStyle-CssClass="odd" 
                    PagerStyle-CssClass="headerfooter ui-toolbar" 
                ...
                <asp:SqlDataSource ID="SqlDsExportRecursos" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:MatrixConnectionString %>" 
                    SelectCommand="OP_PL_PropuestasAltaProbabilidadRecursos_Datos" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlGerencias" Name="GERENCIA" 
                            PropertyName="SelectedValue" Type="Int64" />
                        <asp:ControlParameter ControlID="ddlUnidades" Name="UNIDAD" 
                    ...
                    <div class="form_rigth">
                        ...
                        <asp:Button ID="btnExportR" Visible="false" runat="server" Text="Exportar datos recursos a Excel" OnClientClick="$('#dialog-factores').dialog('close');" />
                    </div>
                    <div class="actions"></div>
            </ContentTemplate>
        </asp:UpdatePanel>
