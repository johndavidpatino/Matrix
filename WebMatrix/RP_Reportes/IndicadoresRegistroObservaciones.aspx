<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/MasterPage/MPNewMatrix.Master" CodeBehind="IndicadoresRegistroObservaciones.aspx.vb" Inherits="WebMatrix._IndicadoresRegistroObservaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../Scripts/js/Components/Lit/index.js?v1" type="module"></script>
    <script src="../Scripts/js/reportes/reporte-observaciones-filters.js" type="module" defer></script>
    <script src="../Scripts/js/reportes/main-chart.js" type="module" defer></script>
    <script src="../Scripts/js/reportes/analisis-indicador.js?v1" type="module" defer></script>
    ...
    <main class="report-container">
        <section id="filtersForm" class="filters-section">
            ...
            <div class="filters-container">
                ...
                <mx-select id="instFilter" hasemptyoption emptyoptionlabel="---Seleccione---" class="mx-hidden">
        ...
        <article class="chart-card mx-hidden" id="chartContainer">
            ...
            <div class="mx-buttons-group">
                <mx-button variant="outline" id="btnExportAgrupadoExcel">Descargar Datos Agrupados</mx-button>
                <mx-button variant="outline" id="btnExportDetallesExcel">Descargar Detalles</mx-button>
            </div>
        </article>
        ...
        <section class="links-section">
            <a class="mx-link" href="ReportesIndicadoresRegistroObservaciones.aspx">Ver version anterior</a>
        </section>
    </main>
</asp:Content>
