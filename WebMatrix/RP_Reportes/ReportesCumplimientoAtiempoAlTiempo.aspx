<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterREP.master" CodeBehind="ReportesCumplimientoAtiempoAlTiempo.aspx.vb" Inherits="WebMatrix.ReportesCumplimientoAtiempoAlTiempo" %>
                    ...
                    <asp:Panel runat="server" ID="pnlData" Visible="false">
                        <div style="margin-top: 30px">
                            <div id="accordionDataGP">
                                <h2>Datos Agrupados GerenteProyectos</h2>
                            ...
                            <div id="accordionDataDetGP">
                                <h2>Detalles Por Usuario Gerente Proyectos</h2>
                                <div style="max-width: 100%; min-height: 300px; max-height: 300px;">
                                    <asp:Button Text="Exportar a Excel" runat="server" ID="btnExcelDetalle" />
                                    <br />
                                    <asp:GridView ID="gvDatosDetalle" runat="server" AutoGenerateColumns="True"
                                        AllowPaging="false" ShowHeader="true" EmptyDataText="No existen registros para mostrar">
