<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/OPQ_F.master"
    CodeBehind="Cuestionario.aspx.vb" Inherits="WebMatrix.Cuestionario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_Head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function redireccion() {
            ...
            document.location.href = 'Cuestionario.aspx?idtrabajo=' + idtrabajo;
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>REGISTRO OBSERVACIONES A INSTRUMENTOS DE ENTREGA (CUESTIONARIO)</a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion1">
                    <h3>
                        <a href="#">
                            <label>
                                Anotaciones Durante la Revisión del Cuestionario</label>
                        </a>
                            ...
                            <div id="tab-1">
                                <asp:Panel ID="pnllistarevision" runat="server" Height="350px" ScrollBars="Auto">
                                    <asp:GridView ID="gvRevision" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="25"
                                        ...
                                        DataKeyNames="Id" EmptyDataText="No existen registros para mostrar" Caption="ANOTACIONES DURANTE LA REVISIÓN DEL CUESTIONARIO"
                                        ShowFooter="True">
                                            ...
                                            <asp:TemplateField HeaderText="Observación">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtObservacionedit" MaxLength="1" runat="server" Text='<%# Bind("Observacion") %>'
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteTxtObservacion1" runat="server" FilterType="Custom"
                                                    TargetControlID="txtObservacionedit" ValidChars="ESes"></asp:FilteredTextBoxExtender>
                                                </EditItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtObservacionfooter" runat="server" MaxLength="1" CssClass="textEntry" Width="140px"
                                                        BorderColor="Silver" BorderStyle="Solid"></asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="fteTxtObservacion1" runat="server" FilterType="Custom"
                            ...
                            <div id="tab-2">
                                <asp:Panel ID="pnllistaejecucion" runat="server" Height="350px" ScrollBars="Auto">
                                    <asp:GridView ID="gvEjecucion" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="25"
                                        CssClass="displayTable" AlternatingRowStyle-CssClass="odd" PagerStyle-CssClass="headerfooter ui-toolbar"
                                        DataKeyNames="Id" EmptyDataText="No existen registros para mostrar" Caption="ANOTACIONES DURANTE LA EJECUCIÓN DEL CUESTIONARIO"
                                        ShowFooter="True">
                                        <PagerStyle CssClass="headerfooter ui-toolbar" />
                                        <SelectedRowStyle CssClass="SelectedRow" />
                                        <AlternatingRowStyle CssClass="odd" />
                                            ...
                                            <table style="vertical-align: top">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtObservacionEmpty"  MaxLength="1" runat="server" CssClass="textEntry" Width="140px"
                                                            BorderColor="Silver" BorderStyle="Solid"></asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="fteTxtObservacion2" runat="server" FilterType="Custom"
                                                    TargetControlID="txtObservacionEmpty" ValidChars="ESes"></asp:FilteredTextBoxExtender>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtDescripcionEmpty" runat="server" CssClass="textEntry" Width="140px"
                        ...
                        <div class="actions">
                            <div class="form_right">
                                <fieldset>
                                    ...
                                    &nbsp;
                                    <input id="Button1" type="button" value="Cancelar" class="button"
