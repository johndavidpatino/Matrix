<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/OPQ_F.master" CodeBehind="MaterialAyuda.aspx.vb" Inherits="WebMatrix.MaterialAyuda" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_Head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function redireccion() {
            ...
            document.location.href = 'MaterialAyuda.aspx?idtrabajo=' + idtrabajo;
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Titulo" runat="server">
    <a>REGISTRO OBSERVACIONES A INSTRUMENTOS DE ENTREGA (MATERIAL DE AYUDA)</a>
</asp:Content>
            ...
            <div id="accordion">
                <div id="accordion1">
                    <h3>
                        <a href="#">
                            <label>
                                Anotaciones Durante la Revisión del Material de Ayuda</label>
                        </a>
                            ...
                            <div id="tab-1">
                                <asp:Panel ID="pnllistarevision" runat="server" Height="350px" ScrollBars="Auto">
                                    <asp:GridView ID="gvRevision" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="25"
                                        ...
                                        DataKeyNames="Id" EmptyDataText="No existen registros para mostrar" Caption="ANOTACIONES DURANTE LA REVISIÓN DEL MATERIAL DE AYUDA"
                                        ShowFooter="True">
                            ...
                            <div id="tab-2">
                                <asp:Panel ID="pnllistaejecucion" runat="server" Height="350px" ScrollBars="Auto">
                                    <asp:GridView ID="gvEjecucion" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="25"
                                        CssClass="displayTable" AlternatingRowStyle-CssClass="odd" PagerStyle-CssClass="headerfooter ui-toolbar"
                                        DataKeyNames="Id" EmptyDataText="No existen registros para mostrar" Caption="ANOTACIONES DURANTE LA EJECUCIÓN DEL MATERIAL DE AYUDA"
                                        ShowFooter="True">
                                        <PagerStyle CssClass="headerfooter ui-toolbar" />
                                        <SelectedRowStyle CssClass="SelectedRow" />
                                        <AlternatingRowStyle CssClass="odd" />
