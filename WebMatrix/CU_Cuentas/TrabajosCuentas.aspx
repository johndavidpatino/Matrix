<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/OPQ_F.master"
    CodeBehind="TrabajosCuentas.aspx.vb" Inherits="WebMatrix.TrabajosCuentas" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_ContentForm" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upDatos">
        <ContentTemplate>
            <asp:Button ID="btnVolver" runat="server" Text="Volver a Estudios" />
                    ...
                    <div class="block">
                        <asp:GridView ID="gvTrabajos" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Cronograma" ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgIrGestionar" runat="server" CausesValidation="False" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                            CommandName="Cronograma" ImageUrl="~/Images/list_16_.png" Text="Actualizar"
