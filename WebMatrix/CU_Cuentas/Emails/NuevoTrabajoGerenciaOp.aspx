<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NuevoTrabajoGerenciaOp.aspx.vb" Inherits="WebMatrix.NuevoTrabajoGerenciaOpMail" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size:12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;color:#333333;">
                <p style="margin:0 0 0 0;padding:0 0 0 0;">Ha sido creado un nuevo trabajo para asignación de OMP con nombre: <asp:Label ID="lblTrabajo" runat="server"></asp:Label></p><br />
