...
#Region "Eventos"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("idtrabajo") IsNot Nothing Then
            ...
            Me.hplLink.NavigateUrl = Me.Request.Url.Scheme & Uri.SchemeDelimiter & Me.Request.Url.Authority & "/ES_Estadistica/MetodologiaDeCampo.aspx?idtrabajo=" & estudio
            GenerarHtml()
