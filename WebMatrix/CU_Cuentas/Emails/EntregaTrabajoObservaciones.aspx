<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EntregaTrabajoObservaciones.aspx.vb"
    Inherits="WebMatrix.EntregaTrabajoObservaciones" %>
...
<body>
    ...
    -moz-border-radius: 5px; -webkit-border-radius: 5px; -ms-border-radius: 5px; border-radius: 5px;
                    ...
                    <tr style="color: #555;">
                        ...
                        <td>
                            <asp:Label ID="lblFlashReportVerbal" runat="server"></asp:Label>
                        </td>
                        </tr>
                        <tr>
                        <tr style="color: #049D9C;">
                        ...
                        <td>
                            <asp:Label ID="lblFlashReportEscrito" runat="server"></asp:Label>
                        </td>
                        <td></td>
                        <td></td>
                        </tr>
                        ...
                        <td>
                            <asp:Label ID="lblCallCenter" runat="server"></asp:Label>
                        </td>
                        <td>
                            Saca Cita
                        </td>
                        <td>
                            <asp:Label ID="lblSacaCita" runat="server"></asp:Label>
                        </td>
                        </tr>
                        <tr>
                        <tr style="color: #555;">
                        ...
                        <td>
                            <asp:Label ID="lblTranscripcion" runat="server"></asp:Label>
                        </td>
                        <td>
                            Grabación
                        </td>
                        <td>
                            <asp:Label ID="lblGrabacion" runat="server"></asp:Label>
                        </td>
                        </tr>
                        <tr>
                        <td style="background-color: Navy; color: White; text-align: center;" colspan="4">
                    ...
                    <tr style="color: #049D9C;">
                        ...
                        <td>
                            Entrega Filtro Reclutamiento
                        </td>
                        <td>
                            <asp:Label ID="lblEntregaFiltroReclutamiento" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr style="color: #555;">
                        <td>
