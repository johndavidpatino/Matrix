    ...
    <div>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size:12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;color:#333333;">
                ...
                <p style="margin:0 0 0 0;padding:0 0 0 0;">Para ver el listado de trabajos asignados ingrese directamente a Matrix.  <asp:HyperLink ID="hplLink" runat="server" Text="haga clic aquí"></asp:HyperLink> (solo COE's)</p>
            </div>
        </asp:Panel>
    </div>
    </form>
