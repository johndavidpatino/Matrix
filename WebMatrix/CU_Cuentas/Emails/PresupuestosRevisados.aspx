    ...
    <div>
        ...
        <asp:Panel ID="pnlBody" runat="server" Width="90%">
            <div style="font-size:12px; font-family: 'Metrophobic', Arial, serif; font-weight: 400;color:#333333;">
                <p style="margin:0 0 0 0;padding:0 0 0 0;">Han sido enviados revisados los presupuestos de la propuesta: <asp:Label ID="lblTitulo" runat="server"></asp:Label></p><br />
