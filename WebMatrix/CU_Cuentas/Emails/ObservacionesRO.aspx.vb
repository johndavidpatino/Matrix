    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("idTrabajo") IsNot Nothing Then
            ...
            If Request.QueryString("fromgerencia") IsNot Nothing Then
                Me.hplLink.NavigateUrl = Me.Request.Url.Scheme & Uri.SchemeDelimiter & Me.Request.Url.Authority & "/OP_RO/" & TipoRO & ".aspx?idtrabajo=" & Request.QueryString("idTrabajo") & "&fromgerencia=yes"
            Else
                Me.hplLink.NavigateUrl = Me.Request.Url.Scheme & Uri.SchemeDelimiter & Me.Request.Url.Authority & "/OP_RO/" & TipoRO & ".aspx?idtrabajo=" & Request.QueryString("idTrabajo")
            End If
