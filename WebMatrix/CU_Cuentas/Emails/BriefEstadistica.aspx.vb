...
Public Class BriefEstadisticaMail
...
#Region "Eventos"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("idBrief") IsNot Nothing Then
            ...
            Me.hplLink.NavigateUrl = Me.Request.Url.Scheme & Uri.SchemeDelimiter & Me.Request.Url.Authority & "/ES_Estadistica/BriefDisenoDeMuestra.aspx?idPropuesta=" & info.Propuestaid & "&brieflist"
            GenerarHtml()
