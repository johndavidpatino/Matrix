<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/CU_F.master" CodeBehind="EnviarProducto.aspx.vb" Inherits="WebMatrix.EnviarProducto" %>
...
<div Id="datos" runat="server" visible="false">
    ...
    <div class="actions" runat="server" id="Tpl"></div>
    <div class="actions">
