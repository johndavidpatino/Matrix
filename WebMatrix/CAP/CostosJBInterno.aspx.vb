...
Public Class CostosJBInterno
    ...
    Private Sub CargarCostos(ByVal P As IQ_Parametros)
        gvJBInterno.DataSource = _Consultas.ObtenerCostosJobBookInterno(P).Tables(0)
    ...
    Private Sub ExportarExcel(ByVal gv As GridView)
        ...
        'Response.AddHeader("Content-Disposition", "attachment;filename= JB_interno.xls")
        ...
        wb.Worksheets.Add(_Consultas.ObtenerCostosJobBookInterno(CType(Session("PARAMETROS"), IQ_Parametros)).Tables(0))
    ...
    Private Sub Crearexcel(ByVal workbook As XLWorkbook, ByVal name As String)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=""JB_Interno.xlsx""")
