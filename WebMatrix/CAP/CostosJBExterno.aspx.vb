...
Public Class CostosJBExterno
    ...
    Private Sub CargarCostos(ByVal p As IQ_Parametros)
        gvJBExterno.DataSource = _Consultas.ObtenerCostosJobBookExterno(p).Tables(0)
    ...
    Private Sub ExportarExcel(ByVal gv As GridView)
        ...
        wb.Worksheets.Add(_Consultas.ObtenerCostosJobBookExterno(CType(Session("PARAMETROS"), IQ_Parametros)).Tables(0))
