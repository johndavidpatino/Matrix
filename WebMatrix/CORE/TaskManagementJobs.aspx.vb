...
Public Class TaskManagementJobs
...
#End Region
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If hfEstadoId.Value = eEstadoBloqueo.Anulado Or hfEstadoId.Value = eEstadoBloqueo.Cerrado Then
			...
			ShowWarning(TypesWarning.Information, "Este Trabajo no puede ser modificado porque está Anulado o Cerrado")
		Else
	...
	Sub MenuCall(sender As Object, e As EventArgs)
		Dim numopcion As String = DirectCast(sender, HtmlAnchor).ID.Remove(0, 10)

		Select Case numopcion
			Case "1"
				Me.pnlTareasXTrabajo.Visible = True
	...
	Private Shared Function esTareaConRegistroObservacion(lstTareas As CT_TareasList_Result) As Boolean?
		Return lstTareas.TareaId = eTarea.Instrumentos OrElse
			...
			lstTareas.TareaId = eTarea.VariablesControlEvaluaGP
	End Function
	...
	Protected Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
		...
		Try
			...
			ShowWarning(TypesWarning.Information, "El proceso de devolución ha sido realizado satisfactoriamente!")
		Catch ex As Exception
			ShowWarning(TypesWarning.ErrorMessage, "Ha ocurrido un error - " & ex.Message)
		End Try
	...
	Private Sub gvEstimacion_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvEstimacion.RowCommand
		...
		hfTareaIdEstimacion.Value = Int64.Parse(Me.gvEstimacion.DataKeys(CInt(e.CommandArgument))("TareaId"))
		hfRowIdEstimacion.Value = CInt(e.CommandArgument)
		'Dim txtI As New TextBox
		'Dim txtE As New TextBox
		'txtI = DirectCast(Me.gvEstimacion.Rows(hfRowIdEstimacion.Value).FindControl("txtFinicio"), TextBox)
		'txtE = DirectCast(Me.gvEstimacion.Rows(hfRowIdEstimacion.Value).FindControl("txtFFin"), TextBox)
		'If IsDate(txtI.Text) Then deStart.Text = txtI.Text
		'If IsDate(txtE.Text) Then deStart.Text = txtE.Text
		'upEstimacionFechas.Update()
	End Sub
	...
	Protected Sub btnGuardarEstimacion_Click(sender As Object, e As EventArgs) Handles btnGuardarEstimacion.Click
		...
		For Each row As GridViewRow In Me.gvEstimacion.Rows
			...
			If fechaInicio.HasValue AndAlso fechaFin.HasValue AndAlso fechaInicio > fechaFin Then
				ShowWarning(TypesWarning.Warning, ShowNotifications.InfoNotification)
		...
		Next
		CargarEstimacion()
		ShowWarning(TypesWarning.Information, "Cambios almacenados corretamente")
		''If flag Then
		''	oGt.GuardarWorkFlowContext()
		''	CargarEstimacion()
	...
	Protected Sub btnEstimarOk_Click(sender As Object, e As EventArgs)
		'DirectCast(Me.gvEstimacion.Rows(hfRowIdEstimacion.Value).FindControl("txtFinicio"), TextBox).Text = deStart.Text
		'DirectCast(Me.gvEstimacion.Rows(hfRowIdEstimacion.Value).FindControl("txtFFin"), TextBox).Text = deEnd.Text
		'Me.upEstimacionFechas.Update()
	End Sub
	...
	Private Sub upEstimacionFechas_Unload(sender As Object, e As EventArgs) Handles upEstimacionFechas.Unload
		RegisterUpdatePanel(DirectCast(sender, UpdatePanel))
	End Sub

	Private Sub UPanelGeneral_Unload(sender As Object, e As EventArgs) Handles UPanelGeneral.Unload
		RegisterUpdatePanel(DirectCast(sender, UpdatePanel))
	End Sub
End Class