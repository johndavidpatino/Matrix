<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/CU_F.master"
    CodeBehind="Configuracion_Tareas_Previas.aspx.vb" Inherits="WebMatrix.Configuracion_Tareas_Previas" %>
        ...
        <div id="accordion0">
            ...
            <div class="block">
                <asp:GridView ID="gvTareasAsignadas" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                    ...
                    DataKeyNames="Id, CORE_TareasPrevias_Id" AllowPaging="True" EmptyDataText="No existen registros para mostrar">
                        ...
                        <asp:TemplateField HeaderText="Adicionar" ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgAdicionar" ImageUrl="/Images/Select_16.png" ToolTip="Adicionar"
                                    runat="server" AlternateText="Adicionar" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Adicionar"  />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    </Columns>
