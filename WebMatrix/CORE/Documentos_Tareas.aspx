<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/PY_F.master"
    CodeBehind="Documentos_Tareas.aspx.vb" Inherits="WebMatrix.Documentos_Tareas" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPH_ContentForm" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upDatos">
        <ContentTemplate>
            ...
            <br />
            <asp:LinkButton ID="lnkTarea" runat="server" Text="Volver a tarea"></asp:LinkButton>
            <div id="accordion">
                <div id="accordion0">
                    <h3>
                        <a href="#">
                    ...
                    <div class="block">
                        <asp:GridView ID="gvArchivosRequeridos" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                            CssClass="displayTable" AlternatingRowStyle-CssClass="odd" PagerStyle-CssClass="headerfooter ui-toolbar"
                            DataKeyNames="TareaId, IdDocumento" AllowPaging="True" EmptyDataText="No existen registros para mostrar">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument="First" CommandName="Page"
                                                    Enabled='<%# IIF(gvArchivosRequeridos.PageIndex = 0, "false", "true") %>' SkinID="Paging">« Primero</asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument="Prev" CommandName="Page"
                                                    Enabled='<%# IIF(gvArchivosRequeridos.PageIndex = 0, "false", "true") %>' SkinID="paging">&lt; Anterior</asp:LinkButton>
                                            </td>
                                            <td>
                                                <span class="pagingLinks">[<%= gvArchivosRequeridos.PageIndex + 1%>-<%= gvArchivosRequeridos.PageCount%>]</span>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument="Next" CommandName="Page"
                                                    Enabled='<%# IIF((gvArchivosRequeridos.PageIndex +1) = gvArchivosRequeridos.PageCount, "false", "true") %>'
                ...
                <div id="accordion1">
                    ...
                    <div class="block">
                        <asp:GridView ID="gvArchivosEntregables" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                            CssClass="displayTable" AlternatingRowStyle-CssClass="odd" PagerStyle-CssClass="headerfooter ui-toolbar"
                            DataKeyNames="TareaId, IdDocumento" AllowPaging="True" EmptyDataText="No existen registros para mostrar">
                            <PagerStyle CssClass="headerfooter ui-toolbar" />
                            <SelectedRowStyle CssClass="SelectedRow" />
                                ...
                                <div class="pagingButtons">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument="First" CommandName="Page"
                                                    Enabled='<%# IIF(gvArchivosEntregables.PageIndex = 0, "false", "true") %>' SkinID="Paging">« Primero</asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument="Prev" CommandName="Page"
                                                    Enabled='<%# IIF(gvArchivosEntregables.PageIndex = 0, "false", "true") %>' SkinID="paging">&lt; Anterior</asp:LinkButton>
                                            </td>
                                            <td>
                                                <span class="pagingLinks">[<%= gvArchivosEntregables.PageIndex + 1%>-<%= gvArchivosEntregables.PageCount%>]</span>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument="Next" CommandName="Page"
                                                    Enabled='<%# IIF((gvArchivosEntregables.PageIndex +1) = gvArchivosEntregables.PageCount, "false", "true") %>'
                                                    SkinID="paging">Siguiente &gt;</asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="LinkButton4" runat="server" CommandArgument="Last" CommandName="Page"
