...
Public Class GerenciaAOT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AOTMetaTotal.Text = FusionCharts.RenderChart("../FusionWidgets/HLinearGauge.swf", "", xmlAOTTotalM.ToString(), "chartid1", "100%", "95%", False, True)
        ...
        AOTMetaMes.Text = FusionCharts.RenderChart("../FusionWidgets/HLinearGauge.swf", "", xmlAOTMesM.ToString(), "chartid3", "100%", "95%", False, True)
        ...
        AOTBudgetMes.Text = FusionCharts.RenderChart("../FusionWidgets/HLinearGauge.swf", "", xmlAOTMesB.ToString(), "chartid4", "100%", "95%", False, True)
